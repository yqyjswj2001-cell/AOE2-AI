...
GAP_MESSAGES = {
    ...
    "CURSOR_HOOK_USAGE_WAITING": "已绑定 Cursor conversation，但本轮 stop Hook 尚未带回 token。",
    "CURSOR_HOOK_TOKEN_FIELDS_INVALID": "Cursor stop Hook 的 token 字段缺失或与缓存分项冲突，未计入。",
    "CURSOR_HOOK_SUBAGENT_UNREPORTED": "stop Hook 只包含父代理本轮 token，子代理消耗未计入。",
