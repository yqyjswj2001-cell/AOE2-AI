...
=>
	...
	(set-goal water-micro yes)
)
(defrule
	(population < 150)
	(or(unit-type-count archery-class > 0)
...
(defrule
	...
	(or(players-unit-type-count any-enemy arrow-ship-line > 1)
...
(or	(and	(strategic-number teamsuperiority >= 0)
		(and	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_002}});
			(military-population >= {{TSA_MY_MILITARY_001}}))); 13
(or	(military-population >= {{TSA_MY_MILITARY_002}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_003}})
	(population >= max-civ-pop))))
=>
...
(or	(and	(strategic-number teamsuperiority >= 1)
		(and	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_004}});
			(military-population >= {{TSA_MY_MILITARY_003}})))
(or	(military-population >= {{TSA_MY_MILITARY_004}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_005}})
	(population >= max-civ-pop))))
=>
	(set-goal attacking yes))
(defrule
...
(or	(and	(strategic-number teamsuperiority >= 0)
		(and	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_006}});
			(military-population >= {{TSA_MY_MILITARY_005}})))
(or	(military-population >= {{TSA_MY_MILITARY_006}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_007}}); 2
	(population >= max-civ-pop))))
=>
...
=>
	(up-jump-rule 2))
(defrule
	(military-population >= {{TSA_MY_MILITARY_008}})
(or	(and	(players-military-population target-player <= {{TSA_ENEMY_MILITARY_001}})
		(military-population >= {{TSA_MY_MILITARY_009}})); 5
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_013}}))
	(up-compare-goal attacking != yes)
=>
	(set-goal attacking yes))
(defrule
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_014}}); attack with >= 2 above
	(players-building-type-count target-player watch-tower < 2); 1
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_015}})
...
(or	(military-population >= {{TSA_MY_MILITARY_010}}); 36
	(unit-type-count archer-line >= 12)))); 18
	(up-compare-goal attacking != yes)
=>
	(set-goal attacking yes)); end jump
(defrule
(or	(players-military-population focus-player >= {{TSA_ENEMY_MILITARY_002}}); target
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_016}}))
(or	(and	(players-current-age target-player >= castle-age)
		(and	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_017}})
			(current-age <= feudal-age)))
	(and	(goal attacking yes)
		(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_018}})))
;	(goal attacking yes)
=>
...
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_020}})
...
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_021}})
...
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_022}})
...
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_023}})
...
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_024}})
...
(defrule
	...
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_025}}); 2
...
(or	(players-building-type-count target-player watch-tower >= 5)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_026}})); 3
...
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_027}})
	(goal sk-var no)
...
(or	(building-type-count-total town-center >= 4); 3
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_028}}))
...
(defrule
	...
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_029}})
	(military-population < {{TSA_MY_MILITARY_011}})
(or	(goal assistance no)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_030}}))
...
(defrule
	...
	(military-population < {{TSA_MY_MILITARY_013}})
;	(up-projectile-target projectile-watch-tower == archery-class)
	(up-projectile-detected projectile-watch-tower < 3000)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_032}})
...
;j	(goal strategy a-rush)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_040}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_041}})
...
(or	(military-population >= {{TSA_MY_MILITARY_017}})
	(and	(military-population >= {{TSA_MY_MILITARY_018}})
		(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_042}})
			(players-current-age target-player <= feudal-age))))
...
(or	(strategic-number teamsuperiority >= -1)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_043}})))
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_044}})
	(players-building-type-count target-player watch-tower < 2); 1
	(military-population >= {{TSA_MY_MILITARY_019}})
...
;	(goal strategy a-rush)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_045}})
(or	(unit-type-count 26 >= 3); dead x-bows
(or	(goal defend yes)
(or	(goal underattack yes)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_046}}))))
(or	(strategic-number skirms >= 7)
(or	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_047}})
	(players-current-age target-player >= castle-age)))
;	(goal attacking yes)
=>
;	(set-goal attacking no)
...
(defrule
;	(goal strategy a-rush)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_048}})
...
(defrule
;	(goal strategy a-rush)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_049}})
(or	(players-unit-type-count target-player mangonel-line >= 1)
...
(defrule
;	(goal strategy a-rush)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_050}})
(or	(players-unit-type-count target-player mangonel-line >= 2)
...
(defrule
;	(goal strategy a-rush)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_051}})
...
;	(goal strategy a-rush)
	(unit-type-count siege-weapon-class <= 0)
	(unit-type-count knight-line <= 2)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_052}})
(or	(and	(players-building-type-count target-player watch-tower >= 3)
...
;	(goal strategy a-rush)
	...
	(unit-type-count knight-line <= 0)
(or	(players-building-type-count target-player watch-tower >= 5)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_053}}))
(or	(and	(players-building-type-count target-player watch-tower >= 4)
		(up-projectile-detected projectile-watch-tower < 3000))
(or	(players-unit-type-count target-player mangonel-line >= 2)
	(players-unit-type-count target-player scorpion-line >= 3)))
...
(defrule
;	(goal strategy a-rush)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_054}})
...
;	(up-projectile-target projectile-watch-tower == archery-class)
	(up-projectile-detected projectile-watch-tower < 3000)
	(military-population < {{TSA_MY_MILITARY_021}})
	(unit-type-count knight-line < 4)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_056}})
	(up-compare-flag retreat-flag != 2)
=>
	(set-goal attacking no)
	(up-modify-flag retreat-flag c:+ 2))
(defrule
;	(goal strategy a-rush)
	(military-population < {{TSA_MY_MILITARY_022}})
	(up-projectile-target projectile-watch-tower == archery-class)
	(up-projectile-detected projectile-watch-tower < 3000)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_057}})
	(up-timer-status resetnow == timer-disabled)
;	(goal attacking yes)
=>
	(set-goal attacking no)
...
=>
	(up-jump-rule 15))
(defrule
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_060}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_061}})
	(and	(players-unit-type-count target-player knight-line <= 4)
		(or	(players-building-type-count target-player stable <= 1)
			(players-current-age target-player <= feudal-age))))
(or	(military-population >= {{TSA_MY_MILITARY_024}})
	(and	(military-population >= {{TSA_MY_MILITARY_025}})
		(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_062}})
			(players-current-age target-player <= feudal-age))))
;tl	(goal attacking no)
=>
	(set-goal attacking yes))
...
(or	(population >= max-civ-pop)
(or	(strategic-number teamsuperiority >= -1)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_063}})))
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_064}})
	(players-building-type-count target-player watch-tower < 2); 1
	(military-population >= {{TSA_MY_MILITARY_026}})
	(up-research-status c: ri-bodkin-arrow >= research-pending)
	(goal attacking no)
=>
	(set-goal attacking yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_065}})
(or	(unit-type-count 34 >= 2); dead cava
(or	(goal defend yes)
(or	(goal underattack yes)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_066}}))))
(or	(strategic-number skirms >= 7)
(or	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_067}})
	(players-current-age target-player >= castle-age)))
;	(goal attacking yes)
=>
;	(set-goal attacking no)
	...
	(chat-local-to-self "1."))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_068}})
(or	(players-unit-type-count target-player mangonel-line >= 1)
(or	(players-unit-type-count target-player scorpion-line >= 1)
...
;	(set-goal attacking no)
	...
	(chat-local-to-self "2."))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_069}})
(or	(players-unit-type-count target-player mangonel-line >= 2)
(or	(players-unit-type-count target-player scorpion-line >= 2)
(or	(players-unit-type-count target-player eagle-warrior-line >= 14)
...
;	(set-goal attacking no)
	...
	(chat-local-to-self "3."))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_070}})
(or	(players-unit-type-count target-player mangonel-line >= 3)
(or	(players-unit-type-count target-player scorpion-line >= 3)
...
(defrule
	(unit-type-count siege-weapon-class <= 0)
	(unit-type-count knight-line <= 2)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_071}})
(or	(and	(players-building-type-count target-player watch-tower >= 3)
		(and	(strategic-number sn-current-age < imperial)
			(up-projectile-detected projectile-watch-tower < 3000)))
(or	(players-unit-type-count target-player mangonel-line >= 1)
...
(defrule
	...
	(unit-type-count knight-line <= 0)
(or	(players-building-type-count target-player watch-tower >= 5)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_072}}))
(or	(and	(players-building-type-count target-player watch-tower >= 4)
		(up-projectile-detected projectile-watch-tower < 3000))
(or	(players-unit-type-count target-player mangonel-line >= 2)
	(players-unit-type-count target-player scorpion-line >= 3)))
...
;	(set-goal attacking no)
	...
	(chat-local-to-self "7."))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_073}})
(or	(players-unit-type-count target-player war-wagon-line >= 5)
...
;	(up-projectile-target projectile-watch-tower == archery-class)
	(up-projectile-detected projectile-watch-tower < 3000)
	(military-population < {{TSA_MY_MILITARY_028}})
	(unit-type-count knight-line < 4)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_075}})
	(up-compare-flag retreat-flag != 2)
=>
	(set-goal attacking no)
	(up-modify-flag retreat-flag c:+ 2))
(defrule
	(military-population < {{TSA_MY_MILITARY_029}})
	(up-projectile-target projectile-watch-tower == archery-class)
	(up-projectile-detected projectile-watch-tower < 3000)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_076}})
	(up-timer-status resetnow == timer-disabled)
;	(goal attacking yes)
=>
	(set-goal attacking no)
...
(defrule
;tl	(goal attacking no)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_079}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_080}})
	(and	(players-unit-type-count target-player knight-line <= 4)
		(or	(players-building-type-count target-player stable <= 1)
			(players-current-age target-player <= feudal-age))))
(or	(military-population >= {{TSA_MY_MILITARY_031}}); 10
	(and	(military-population >= {{TSA_MY_MILITARY_032}}); 6
		(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_081}})
			(players-current-age target-player <= feudal-age))))
=>
	(set-goal attacking yes))
(defrule
...
(or	(population >= max-civ-pop)
(or	(strategic-number teamsuperiority >= -1)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_082}})))
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_083}}); 3
...
=>
	(set-goal attacking yes))
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_084}})
(or	(and	(unit-type-count 111 >= 8); dead kt
		(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_085}}))
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_086}}))
(or	(strategic-number spears >= 9); 8
	(players-current-age target-player >= castle-age))
(or	(goal attacking yes)
(or	(goal underattack yes)
	(military-population >= {{TSA_MY_MILITARY_033}}))); 16
=>
	(chat-local-to-self "1.")
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
	...
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_087}}); 0
=>
	(chat-local-to-self "1,5.")
;	(set-goal attacking no)
	(set-goal retreatnow yes))
...
(or	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_088}})
	(and	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_089}})
...
=>
	(up-jump-rule 3)); test
(defrule
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_090}})
...
(or	(unit-type-count 111 >= 8); dead kt
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_091}}))
...
;	(set-goal attacking no)
	(set-goal retreatnow yes))
(defrule
(or	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_092}})
	(and	(goal assistance no)
		(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_093}})))
...
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_104}})
(or	(and	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_105}})
		(unit-type-count eagle-warrior-line >= 15))
(or	(and	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_106}})
		(players-current-age target-player <= castle-age))
...
(defrule
	...
	(up-research-status c: ri-elite-eagle-warrior >= research-pending)
	(players-current-age target-player <= feudal-age)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_107}})
	(military-population >= {{TSA_MY_MILITARY_043}})
=>
	(set-goal attacking yes)); end jump
;==============================================================
(defrule
...
(defrule
	(goal attacking no)
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_108}})
	(unit-type-count bombard-cannon-line >= 1))
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_109}})
(or	(and	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_110}})
		(up-compare-goal my-mpop >= 14))
(or	(goal assistance yes)
	(population >= del-civ-pop))))
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_111}})
	(military-population >= {{TSA_MY_MILITARY_044}})
=>
	(set-goal attacking yes))
(defrule
	(goal attacking no)
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_112}})
	(unit-type-count bombard-cannon-line >= 1))
(or	(players-current-age target-player <= feudal-age)
	(up-compare-goal my-mpop g:>= focus-mpop))
	(players-current-age target-player <= castle-age)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_113}})
	(military-population >= {{TSA_MY_MILITARY_045}})
=>
	(set-goal attacking yes)); end jump
;==============================================================
;(defrule
...
(defrule
	...
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_115}})
...
(or	(unit-type-count trebuchet-set >= 2); 3
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_116}}))); 4
	(players-current-age target-player <= castle-age)
	(goal attacking no)
=>
...
(defrule
	(players-building-count any-enemy >= 1)
	(population > up-max-civ)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_117}}); 2
...
(or	(unit-type-count trebuchet-set >= 1)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_118}}))); 4
	(players-current-age target-player <= feudal-age)
	(goal attacking no)
=>
...
;	(population > up-max-civ)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_119}})
	(strategic-number teamsuperiority >= -1); 0
	(current-age >= feudal-age)
(or	(up-compare-goal armytech >= feudal); (current-age-time > 60)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_120}}))
	(military-population >= {{TSA_MY_MILITARY_047}}); 3
	(goal attacking no)
=>
...
(or	(goal researchplan yes)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_121}}))
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_122}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_123}})
...
;	(players-population any-ally < max-civ-pop)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_124}})
	(goal siegereq yes)
...
(defrule
	...
	(goal assistance yes)
	(goal underattack no)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_125}})
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_126}})
	(strategic-number teamsuperiority >= 0))
=>
	(set-goal attacking yes))
...
(defrule
	(goal attacking no)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_127}})
(or	(goal researchplan yes)
	(and	(strategic-number sn-current-age >= imperial)
		(population >= max-pop)))
(or	(population >= siege-pop)
	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_128}}))
...
(or	(and	(unit-type-count trebuchet-set >= 3); 6
		(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_129}}))
(or	(and	(unit-type-count trebuchet-set >= 2); 4
		(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_130}}))
	(and	(unit-type-count trebuchet-set >= 1); 2
		(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_131}}))))
=>
	(set-goal attacking yes))
(defrule
	(goal attacking no)
...
(or	(and	(unit-type-count battering-ram-line >= 6); 7
		(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_132}}))
(or	(and	(unit-type-count battering-ram-line >= 4); 5
		(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_133}}))
	(and	(unit-type-count battering-ram-line >= 2); 3
		(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_134}}))))
=>
	(set-goal attacking yes))
...
(or	(players-unit-type-count focus-player siege-ship >= 8)
(or	(players-unit-type-count focus-player arrow-ship-line >= 10)
(or	(players-unit-type-count focus-player ramming-ship-line >= 5)
(or	(players-unit-type-count focus-player scout-ship-line >= 8)
(or	(players-unit-type-count focus-player mangonel-ship-line >= 5)
	(players-unit-type-count focus-player octeres >= 6)))))))))))
...
(or	(players-unit-type-count focus-player siege-ship >= 20)
(or	(players-unit-type-count focus-player arrow-ship-line >= 22)
(or	(players-unit-type-count focus-player ramming-ship-line >= 18)
(or	(players-unit-type-count focus-player scout-ship-line >= 20)
(or	(players-unit-type-count focus-player mangonel-ship-line >= 15)
	(players-unit-type-count focus-player octeres >= 20)))))))))))
...
(or	(players-unit-type-count focus-player fire-ship-line >= 1)
	(players-unit-type-count focus-player ramming-ship-line >= 1))
(or	(unit-type-count-total galley-line <= 2)
	(or	(players-unit-type-count focus-player ramming-ship-line >= 3)
		(players-unit-type-count focus-player fire-ship-line >= 3)))
(or	(unit-type-count-total galley-line <= 5)
	(or	(players-unit-type-count focus-player ramming-ship-line >= 7)
		(players-unit-type-count focus-player fire-ship-line >= 7)))
(or	(unit-type-count-total galley-line <= 10)
	(or	(players-unit-type-count focus-player ramming-ship-line >= 12)
...
(defrule
	...
	(population < del-civ-pop)
	(up-timer-status resetnow3 != timer-running)
	(unit-type-count octeres < 3)
(or	(up-projectile-detected projectile-castle < 3000)
	(up-projectile-detected projectile-bombard-tower < 3000))
	(up-projectile-target projectile-fortification == warship-class)
=>
	(up-retreat-to shipyard c: warship-class)
	(enable-timer resetnow3 15)
	(set-strategic-number sn-percent-attack-boats 0)
	(set-strategic-number sn-number-boat-attack-groups 0))
(defrule
...
(defrule
(or	(up-compare-goal enemyfocusnavy >= 26)
(or	(players-unit-type-count focus-player galley-line >= 22)
(or	(players-unit-type-count focus-player fire-ship-line >= 18)
(or	(players-unit-type-count focus-player longboat-line >= 20)
(or	(players-unit-type-count focus-player turtle-ship-line >= 15)
(or	(players-unit-type-count focus-player siege-ship >= 20)
...
(defrule
	(goal paphosciv yes)
	(goal strategy grush)
	(unit-type-count-total arrow-ship-line <= 15)
	(players-unit-type-count focus-player ramming-ship-line >= 1)
(or	(players-unit-type-count focus-player fire-ship-line >= 1)
(or	(unit-type-count-total arrow-ship-line <= 2)
(or	(players-unit-type-count focus-player fire-ship-line >= 3)
	(players-unit-type-count focus-player ramming-ship-line >= 3))))
(or	(unit-type-count-total arrow-ship-line <= 5)
(or	(players-unit-type-count focus-player fire-ship-line >= 7)
	(players-unit-type-count focus-player ramming-ship-line >= 7)))
(or	(unit-type-count-total arrow-ship-line <= 10)
(or	(players-unit-type-count focus-player fire-ship-line >= 12)
	(players-unit-type-count focus-player ramming-ship-line >= 12)))
=>
	(up-retreat-to shipyard c: warship-class)
	(enable-timer resetnow3 18)
;	(chat-local-to-self "Retreat: Warships.5")
...
(not	(enemy-buildings-in-town))
	...
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_180}})
...
(defrule
	...
	(strategic-number sn-maximum-town-size < 40)
	(population-cap >= 200)
	(military-population < {{TSA_MY_MILITARY_067}})
	(players-military-population any-enemy >= {{TSA_ENEMY_MILITARY_005}})
	(civilian-population >= 160)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_181}}); 1
...
(defrule
	...
	(up-set-target-object search-remote c: 0)
	(up-compare-goal attacking != no)
	(strategic-number sn-military-superiority <= {{TSA_SUPERIORITY_182}})
	(strategic-number teamsuperiority <= 2)
	(strategic-number sn-current-age < imperial)
	(goal assistance no)
	(military-population < {{TSA_MY_MILITARY_070}})
	(up-compare-goal attackInProgress != yes); test
	(unit-type-count feudal-battering-ram <= 0)
	(unit-type-count battering-ram-line <= 0)
	(unit-type-count bombard-cannon-line <= 0)
...
(or	(goal assistance yes)
(or	(strategic-number sn-military-superiority >= {{TSA_SUPERIORITY_183}})
(or	(game-time >= 6000)
	(population >= max-pop))))))))
=>
...
(and	(players-building-type-count every-enemy dock <= 0)
	(players-building-type-count every-enemy shipyard <= 0))
...
(defrule
	(true)
=>
	(set-goal fishing-ship-garrisoned no)
	(set-goal local-total 0)
)

(defrule
	(unit-type-count-total fishing-ship-class > 0)
=>
	(up-full-reset-search)
	(fe-filter-garrisoned c: 2)
	(up-find-local c: fishing-ship-class c: 5)
	(up-get-search-state local-total)
)
...
=>
	(set-goal fishing-ship-garrisoned yes)
	(set-goal fishing-ship-ever-garrisoned yes)
)
...
(defrule
	...
	(up-set-target-object search-local c: 0)
(or	(unit-type-count fishing-ship >= 1)
	(unit-type-count merchant-ship >= 1))
=>
	(up-full-reset-search)
	(up-find-local c: fishing-ship c: 40)
	(up-find-local c: merchant-ship c: 40)
	(up-remove-objects search-local object-data-garrisoned != 1))
...
=>
	(up-update-targets))
;Additional backup ro reset stance (just in case)
...
=>
	...
	(up-full-reset-search)
	(up-set-attack-stance skirmisher c: stance-aggressive)
	(up-set-attack-stance elite-skirmisher c: stance-aggressive)
	(up-set-attack-stance archer c: stance-aggressive)
	(up-set-attack-stance crossbowman c: stance-aggressive)
	(up-set-attack-stance arbalest c: stance-aggressive)
	(up-set-attack-stance knight c: stance-aggressive)
	(up-set-attack-stance cavalier c: stance-aggressive)
	(up-set-attack-stance pikeman c: stance-aggressive)
	(up-set-attack-stance halberdier c: stance-aggressive)
;	(chat-to-player my-player-number "Debug: resetting stance")
)
...
=>
	...
	(up-set-attack-stance knight c: stance-aggressive)
	(up-set-attack-stance cavalier c: stance-aggressive)
	(up-set-attack-stance pikeman c: stance-defensive)
	(up-set-attack-stance halberdier c: stance-defensive)
;	(chat-to-player my-player-number "Debug: resetting stance")
)
...
(defrule
	...
	(or(unit-type-count my-unique-unit-line > 0)
...
=>
    (up-set-attack-stance militiaman-line c: stance-aggressive)
    (up-set-attack-stance knight-line c: stance-aggressive)
    (up-set-attack-stance spearman-line c: stance-defensive)
    (up-set-attack-stance camel c: stance-aggressive)
    (up-set-attack-stance battle-elephant-line c: stance-aggressive)
)
...
=>
	...
	(up-set-target-object search-local c: 0)
	(up-get-object-data object-data-attack-delay temporary-goal2)
	(up-modify-goal temporary-goal g:- temporary-goal2)
	(up-modify-goal temporary-goal c:max 100)
	(up-modify-sn fd-critical-value g:= temporary-goal)
)
...
=>
 ...
 ;   (up-find-local c: archer c: 60)
	...
	(up-find-local c: cavalry-archer-class c: 40)
...
=>
    ...
    (up-get-group-size c: ranged-group1 temporary-goal)
    (up-modify-goal temporary-goal c:* 2)
    (up-remove-objects search-local object-data-upgrade-type c:== archer)
    (up-get-search-state local-total)
    (up-modify-goal temporary-goal g:+ local-total)
    (up-remove-objects search-local object-data-upgrade-type c:== crossbowman)
    (up-remove-objects search-local object-data-upgrade-type c:== skirmisher)
    (up-get-search-state local-total)
	(up-modify-goal local-total c:* 2);new addition
    (up-modify-goal temporary-goal g:+ local-total)
    (up-remove-objects search-local object-data-upgrade-type c:== arbalest)
    (up-remove-objects search-local object-data-upgrade-type c:== cavalry-archer)
	(up-remove-objects search-local object-data-upgrade-type c:== elite-skirmisher)
	(up-remove-objects search-local object-data-upgrade-type == my-unique-unit)
    (up-modify-goal local-total c:* 3)
    (up-modify-goal temporary-goal g:+ local-total)
	(up-get-search-state local-total);?
    (up-remove-objects search-local object-data-upgrade-type c:!= heavy-cavalry-archer)
    (up-modify-goal local-total c:* 2)
    (up-modify-goal temporary-goal g:+ local-total)
    (up-modify-goal group-advantage g:+ temporary-goal)
)
...
;   (up-full-reset-search)
 ...
 ;   (up-get-group-size c: ranged-group1 temporary-goal)
    ...
    (up-modify-goal temporary-goal c:* 2)
    (up-remove-objects search-remote object-data-upgrade-type c:== archer)
    (up-get-search-state local-total)
    (up-modify-goal temporary-goal g:+ remote-total)
    (up-remove-objects search-remote object-data-upgrade-type c:== crossbowman)
    (up-remove-objects search-remote object-data-upgrade-type c:== skirmisher);skirmisher-line
    (up-get-search-state local-total)
	(up-modify-goal local-total c:* 2);new addition
    (up-modify-goal temporary-goal g:+ remote-total)
    (up-remove-objects search-remote object-data-upgrade-type c:== arbalest)
    (up-remove-objects search-remote object-data-upgrade-type c:== cavalry-archer)
	(up-remove-objects search-remote object-data-upgrade-type c:== elite-skirmisher)
    (up-modify-goal remote-total c:* 3)
    (up-modify-goal temporary-goal g:+ remote-total)
	(up-get-search-state local-total);?
    (up-remove-objects search-remote object-data-upgrade-type c:!= heavy-cavalry-archer)
...
=>
	...
	(up-set-target-object search-local c: 0)
	(up-get-object-data object-data-reload-time reload-time)
	(up-get-object-data object-data-attack-delay temporary-goal2)
	(up-modify-goal reload-time g:- temporary-goal2)
)
; (defrule
;     (goal group-micro yes)
...
(defrule
    ...
    (or(unit-type-count archer-line > 1)
...
(defrule
	...
	(and(up-projectile-detected projectile-fortification < 500)
	(up-group-size c: ranged-group1 < 20)))
   (or(players-civ target-player armenians)
	(players-civ target-player georgians))
...
=>
    (up-full-reset-search)
    (up-set-target-point ranged-group1-x)
    (up-filter-distance c: -1 c: 30);40
    (up-find-remote c: castle c: 5)
	 (up-find-remote c: donjon c: 5);Treat donjons as castles
    (up-clean-search search-remote object-data-distance search-order-asc)
    (up-set-target-object search-remote c: 0)
	(up-get-search-state local-total)
)
...
;    (set-goal block-movement 40)
    ...
    (up-target-point minus-x action-move formation-flank stance-no-attack)
    (up-target-point position-self-x action-move formation-flank stance-no-attack)
    (chat-to-player my-player-number "retreat from castle/donjon")
)
...
=>
	...
	;(up-remove-objects search-remote object-data-garrisoned != 1);doesn't seem to work in this case
	(up-get-search-state local-total)
)
...
(defrule
	...
	(up-compare-goal remote-total > 0)
	(up-point-distance ranged-group1-x position-self-x > 15)
	(or(up-group-size c: ranged-group1 < 25)
	(up-projectile-detected projectile-fortification > 1000))
=>
    (set-goal group-action 6)
    (set-goal group-retreat yes)
;    (set-goal block-movement 40)
    ...
    (up-target-point minus-x action-move formation-flank stance-no-attack)
    (up-target-point position-self-x action-move formation-flank stance-no-attack)
    (chat-to-player my-player-number "retreat from fortified church")
)
(defrule
    (goal group-micro yes)
    (up-group-size c: ranged-group1 > 0)
...
=>
    ...
    (up-set-target-point ranged-group1-x)
    (up-find-remote c: mangonel-line c: 1)
	(up-find-remote c: rocket-cart-line c: 1)
    (up-get-search-state local-total)
...
(defrule
	...
	(players-unit-type-count target-player rocket-cart-line > 0))
    ;(up-compare-goal remote-total > 0)
	(up-compare-goal temporary-goal8 > 0)
=>
    (up-full-reset-search)
...
=>
    ...
    (up-target-objects 1 action-default formation-line stance-stand-ground);stance-no-attack
    (set-goal group-action 7)
)
...
=>
	...
	(up-remove-objects search-local object-data-group-flag == 11)
    (up-set-target-point position-self-x)
    (up-clean-search search-local object-data-distance search-order-asc)
    (up-set-target-object search-local c: 0)
    (up-remove-objects search-local -1 > 0)
...
=>
	...
	(up-set-target-object search-local c: 0)
	(up-get-object-data object-data-id temporary-goal);we have to do this to add stuff to a group since we can't SHIFT + 1 apparantely
	(up-full-reset-search)
	(up-set-group search-local c: 11)
	(up-add-object-by-id search-local g: temporary-goal)
	(up-reset-group c: 11)
	(up-modify-group-flag 0 c: 11)
	(up-create-group 0 0 c: 11)
	(up-modify-group-flag 1 c: 11)
)
