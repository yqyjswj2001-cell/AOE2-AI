...
=>
	(set-strategic-number sn-wood-gatherer-percentage  {{GATHERERS_WOOD_075}}); 49
	(set-strategic-number sn-food-gatherer-percentage  {{GATHERERS_FOOD_075}}); 35
	(set-strategic-number sn-gold-gatherer-percentage  {{GATHERERS_GOLD_076}}); 15
...
=>
	...
	(up-remove-objects search-local object-data-dropsite == lumber-camp)
	(up-clean-search search-local object-data-distance search-order-asc)
