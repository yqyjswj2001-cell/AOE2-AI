...
(or	(up-compare-goal target-cpop g:>= my-cpop)
(or	(up-compare-goal target-pop g:>= my-pop)
(or	(up-compare-goal target-cpop g:>= ten-pop)
(or	(up-compare-goal target-pop g:>= twenty-pop)
	(players-building-type-count target-player feitoria >= 1))))))
=>
	(up-jump-rule 2)); test
(defrule
...
(defrule
	(players-military-population target-player <= {{THREATS_TARGET_SWITCH_001}}); (up-compare-goal temporary-goal3 <= 10)
	(up-compare-goal temporary-goal4 >= {{THREATS_TARGET_SWITCH_002}}); 12
(or	(players-military-population target-player <= {{THREATS_TARGET_SWITCH_003}}); (up-compare-goal temporary-goal3 <= 2)
(or	(and	(players-military-population target-player <= {{THREATS_TARGET_SWITCH_004}}); (up-compare-goal temporary-goal3 <= 6)
		(up-compare-goal temporary-goal4 >= {{THREATS_TARGET_SWITCH_005}})); 24
	(up-compare-goal temporary-goal4 >= {{THREATS_TARGET_SWITCH_006}}))); 36
(or	(up-compare-goal my-mpop g:> temporary-goal4)
	(up-allied-sn any-ally sn-target-player-number g:== temporary-goal2))
	(up-compare-goal my-mpop g:>= temporary-goal4)
=>
	(up-chat-data-to-self "Skipping target, new: %d" g: temporary-goal2)
...
(defrule
(or	(up-compare-goal attacking-enemy > max-players)
...
(defrule
	(goal cozy yes)
	(strategic-number teambalance >= 1); 0
...
(not	(stance-toward focus-player ally))
=>
;	(up-chat-data-to-all "Enemy-pocket: %d." g: enemy-pocket)
...
(defrule
	...
	(up-compare-goal enemy-pocket g:!= temporary-goal7)
(or	(up-compare-goal enemy-pocket g:== gl-threat-player)
...
=>
	(up-jump-rule 1))
(defrule
(or	(strategic-number sn-focus-player-number g:== gl-threat-player)
	(strategic-number sn-focus-player-number g:== attacking-enemy))
	(up-timer-status sup-focus-timer != timer-running)
=>
	(up-get-focus-fact player-number 0 alt-focus)
	(enable-timer sup-focus-timer 120)); 180
(defrule
	(up-timer-status sup-focus-timer == timer-running)
=>
...
=>
	...
	(up-modify-goal temporary-goal6 c:- 10)); 12
(defrule
...
;	(up-chat-data-to-self "jumpgoal: %d" g: jump-rule-goal)
	...
	(set-strategic-number hoplites 0)
...
;	(chat-to-player my-player-number "Debugging threat target player.")
)
(defrule ; debug rule
(or	(not	(player-in-game focus-player))
(or	(strategic-number sn-focus-player-number > max-players)
...
(or	(players-building-count focus-player <= 0)
	(stance-toward focus-player ally)))))
;	(strategic-number sn-focus-player-number != 0); none
=>
;	(up-chat-data-to-player my-player-number "sn-focus-player-number: %d" s: sn-focus-player-number)
	(up-find-player enemy find-closest temporary-goal)
	(up-modify-sn sn-target-player-number g:= temporary-goal); should be an enemy
	(up-modify-sn sn-focus-player-number g:= temporary-goal); should be an enemy
;	(chat-to-player my-player-number "Debugging threat focus player.")
)
;=========================================================
; Cavalry
;=========================================================
...
=>
	...
	(up-modify-sn camels g:+ temporary-goal)
	(up-modify-sn cavalry c:+ 0);s:= camels) ; see below
...
=>
	...
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count elite-stable-tarkan temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count xolotl-warrior temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal)
...
=>
	...
	(up-modify-sn cavalry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count tiger-cavalry-line temporary-goal)
	(up-modify-sn cavalry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count hei-kuang-cavalry-line temporary-goal)
	(up-modify-sn cavalry g:+ temporary-goal)
	...
	(up-get-focus-fact unit-type-count sannahya temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:* 2))
...
=>
	...
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count steppe-lancer temporary-goal)
	(up-get-focus-fact unit-type-count elite-steppe-lancer temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal))
(defrule
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-get-focus-fact unit-type-count leitis temporary-goal)
	(up-get-focus-fact unit-type-count elite-leitis temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count konnik temporary-goal)
	(up-get-focus-fact unit-type-count elite-konnik temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-get-focus-fact unit-type-count krepost-konnik temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-get-focus-fact unit-type-count elite-krepost-konnik temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:/ 2)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal))
(defrule
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-get-focus-fact unit-type-count keshik temporary-goal)
	(up-get-focus-fact unit-type-count elite-keshik temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal)
	...
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count war-chariot temporary-goal)
	(up-get-focus-fact unit-type-count elite-war-chariot temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn cavalry g:+ temporary-goal))
#end-if
...
=>
	...
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn skirms g:+ temporary-goal)
	(up-get-focus-fact unit-type-count genitour-placeholder temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-get-focus-fact unit-type-count guecha-warrior temporary-goal)
	(up-modify-sn skirms g:+ temporary-goal))
(defrule
	(up-compare-const de-game != 1)
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
...
=>
	...
	(up-get-focus-fact unit-type-count elite-kamayuk temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn spears g:+ temporary-goal)
	...
	(up-get-focus-fact unit-type-count hoplite temporary-goal)
	(up-modify-sn hoplites g:+ temporary-goal)
	(up-get-focus-fact unit-type-count phalangite-line temporary-goal)
	(up-modify-sn spears g:+ temporary-goal)
...
(defrule
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-get-focus-fact unit-type-count flemish-pikeman temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn spears g:+ temporary-goal)
	(up-get-focus-fact unit-type-count flemish-pikewoman temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn spears g:+ temporary-goal)
	(up-get-focus-fact unit-type-count flemish-militia temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn spears g:+ temporary-goal))
(defrule
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-get-focus-fact unit-type-count elite-barracks-huskarl temporary-goal)
	(up-modify-sn husks g:+ temporary-goal))
(defrule
	(up-compare-const de-game != 1)
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
...
=>
	...
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn infantry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count condottiero-placeholder temporary-goal);
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn infantry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count foot-konnik temporary-goal)
	(up-get-focus-fact unit-type-count elite-foot-konnik temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:/ 2)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn infantry g:+ temporary-goal))
(defrule
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-get-focus-fact unit-type-count serjeant temporary-goal)
	(up-get-focus-fact unit-type-count elite-serjeant temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-get-focus-fact unit-type-count donjon-serjeant temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-get-focus-fact unit-type-count elite-donjon-serjeant temporary-goal8)
	(up-modify-goal temporary-goal g:+ temporary-goal8)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn infantry g:+ temporary-goal)
	(up-get-focus-fact unit-type-count obuch-line temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn infantry g:+ temporary-goal))
#end-if
;=========================================================
...
=>
	...
	(up-get-fact-max any-enemy unit-type-count monk-with-relic temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn moenche g:+ temporary-goal)
...
(defrule
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-get-focus-fact unit-type-count feudal-battering-ram temporary-goal); double
	(up-modify-goal temporary-goal c:/ 2)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn siege g:+ temporary-goal)
	(up-get-focus-fact unit-type-count battering-ram-line temporary-goal)
	(up-modify-goal temporary-goal c:/ 2)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn siege g:+ temporary-goal)
	(up-get-focus-fact unit-type-count hussite-wagon-line temporary-goal)
	(up-modify-goal temporary-goal c:/ 3)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn siege g:+ temporary-goal)
	(up-get-focus-fact unit-type-count houfnice temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn siege g:+ temporary-goal))
...
=>
	(up-get-focus-fact unit-type-count armored-elephant-line temporary-goal)
	(up-modify-goal temporary-goal c:/ 4);probably best to counter armored eles as both siege and cavalry
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn siege g:+ temporary-goal)
)
;=========================================================
...
(or	(up-compare-goal my-flank2 <= 0)
(or	(strategic-number sn-focus-player-number s:!= sn-target-player-number)
(or	(strategic-number sn-target-player-number <= 0)
(or	(players-military-population every-ally < 20)
...
(or	(players-military-population focus-player >= 12)
	(players-military-population focus-player >= ten-pop))
=>
...
=>
	(up-get-focus-fact unit-type-count plumed-archer-line temporary-goal9)
	(up-get-focus-fact unit-type-count longbowman-line temporary-goal)
	...
	(up-get-focus-fact unit-type-count archer-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count genoese-crossbowman-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count slinger temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count rattan-archer-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count war-wagon-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal))
(defrule
...
=>
	...
	(up-get-focus-fact unit-type-count mangudai-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count elephant-archer-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count camel-archer-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count arambai-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count kipchak-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
	(up-get-focus-fact unit-type-count jaguar-man-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal))
(defrule
...
=>
	...
	(up-get-focus-fact unit-type-count janissary-line temporary-goal)
	(up-modify-goal temporary-goal9 g:+ temporary-goal)
;	(up-chat-data-to-all "Reducing enemy infantry numbers by %d." g: temporary-goal9)
)
(defrule
	(true)
=>
	(up-modify-sn infantry g:- temporary-goal9)
	(up-modify-sn infantry c:max 0)
	(up-modify-sn spears g:- temporary-goal9)
	(up-modify-sn spears c:max 0)
	(up-modify-sn sn-focus-player-number g:= temporary-goal10)); end jump
#end-if
...
=>
	(up-jump-rule 5))
(defrule
(or	(population-headroom >= 125)
	(population-cap >= 250))
	(up-compare-goal tradeunits < 30)
	(up-compare-goal villager-gold < 30)
	(up-compare-goal relic-count < 15)
...
(defrule
	...
	(up-compare-goal villager-gold < 16)
	(up-compare-goal relic-count < 8)
	(up-compare-goal excessGold < 250)
...
(or	(unit-type-count-total sannahya >= 2)	
...
(defrule
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-modify-sn archers s:+ cavarchers)
...
(defrule; c.p.c.
	(strategic-number sn-target-player-number > 0); (strategic-number sn-focus-player-number > 0)
=>
	(up-get-focus-fact unit-type-count fire-galley temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn enemyfocusnavy g:+ temporary-goal)
	(up-get-focus-fact unit-type-count demolition-raft temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn enemyfocusnavy g:+ temporary-goal))
...
(defrule
	(strategic-number sn-target-player-number > 0)
=>
	(up-get-focus-fact unit-type-count arrow-ship-line temporary-goal)
	(up-modify-goal enemyfocusnavy g:+ temporary-goal)
	(up-get-focus-fact unit-type-count scout-ship-line temporary-goal)
	(up-modify-goal enemyfocusnavy g:+ temporary-goal)
	(up-get-focus-fact unit-type-count ramming-ship-line temporary-goal)
	(up-modify-goal enemyfocusnavy g:+ temporary-goal)
	(up-get-focus-fact unit-type-count mangonel-ship-line temporary-goal)
	(up-modify-goal temporary-goal c:* 2)
	(up-modify-goal enemyfocusnavy g:+ temporary-goal)
	(up-get-focus-fact unit-type-count octeres temporary-goal)
	(up-modify-goal enemyfocusnavy g:+ temporary-goal)
	(up-modify-sn enemyfocusnavy g:+ temporary-goal))
...
=>
	(up-get-focus-fact unit-type-count ramming-ship-line temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn biggestenemynavy g:+ temporary-goal)
	(up-get-focus-fact unit-type-count incendiary-ship-line temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-sn biggestenemynavy g:+ temporary-goal)
	; (up-chat-data-to-all "biggestenemynavy: %d" g: biggestenemynavy)
)
...
(defrule; c.p.c.
	(strategic-number sn-target-player-number > 0)
=>
	(up-get-fact-max any-enemy unit-type-count arrow-ship-line temporary-goal)
	(up-modify-goal biggestenemynavy g:+ temporary-goal)
	(up-get-fact-max any-enemy unit-type-count ramming-ship-line temporary-goal)
	(up-modify-goal biggestenemynavy g:+ temporary-goal)
	(up-get-fact-max any-enemy unit-type-count scout-ship-line temporary-goal)
	(up-modify-goal biggestenemynavy g:+ temporary-goal)
	(up-get-fact-max any-enemy unit-type-count mangonel-ship-line temporary-goal)
	(up-modify-goal temporary-goal c:* 2)
	(up-modify-goal biggestenemynavy g:+ temporary-goal)
	(up-get-fact-max any-enemy unit-type-count octeres temporary-goal)
	(up-modify-goal biggestenemynavy g:+ temporary-goal)
	(up-modify-goal biggestenemynavy g:+ temporary-goal))
(defrule; c.p.c.
	(strategic-number sn-target-player-number > 0)
...
=>
	(up-modify-goal point-y s:= sn-focus-player-number)
	(up-modify-sn sn-focus-player-number s:= sn-target-player-number)
	(up-full-reset-search)
	(up-find-remote c: watch-tower c: 10)
	(up-find-remote c: bombard-tower c: 10)
	(up-find-remote c: krepost c: 10)
	...
	(up-modify-sn sn-focus-player-number g:= point-y)); end jump
(defrule
...
(defrule
	(up-compare-goal temporary-goal2 g:>= allowed-num-military)
	(strategic-number sn-military-superiority >= -2)
	(goal attacking no)
	(up-compare-goal my-mpop <= 1)
...
=>
	...
	(set-strategic-number sn-focus-player-number 1)
	(up-modify-goal teamsuperiority-number g:= my-mpop))
(defrule; end neg jump
...
=>
	...
	(up-modify-goal teamsuperiority-number g:+ temporary-goal6)
	(up-jump-rule 1))
(defrule
...
(defrule
	(true)
=>
;	(up-chat-data-to-self "Team-superiority-number: %d." g: teamsuperiority-number)
	(up-modify-sn sn-focus-player-number g:= temporary-goal8))

(defrule
	(strategic-number teamsuperiority != 0)
	(up-compare-goal teamsuperiority-number <= 7)
	(up-compare-goal teamsuperiority-number >= -7)
=>
	(set-strategic-number teamsuperiority 0))
(defrule
	(strategic-number teamsuperiority != 1)
	(up-compare-goal teamsuperiority-number >= 8)
 (or	(and	(current-age >= castle-age)
		(up-compare-goal teamsuperiority-number <= 21))
	(and	(current-age <= feudal-age)
		(up-compare-goal teamsuperiority-number <= 14))); 12
=>
	(set-strategic-number teamsuperiority 1))
(defrule
	(strategic-number teamsuperiority != 2)
	(up-compare-goal teamsuperiority-number <= 49)
(or	(and	(current-age >= castle-age)
		(up-compare-goal teamsuperiority-number >= 22))
	(and	(current-age <= feudal-age)
		(up-compare-goal teamsuperiority-number >= 15))); 13
=>
	(set-strategic-number teamsuperiority 2))
(defrule
	(strategic-number teamsuperiority != 3)
	(up-compare-goal teamsuperiority-number >= 50)
=>
...
=>
	...
	(up-jump-rule 5))
(defrule
(or	(unit-type-count-total imperial-camel >= 3)
(or	(unit-type-count-total scout-cavalry-class >= 3)
(or	(unit-type-count-total cavalry-class >= 3)
(or	(unit-type-count-total magyar-huszar >= 3)
(or	(unit-type-count-total boyar >= 3)
(or	(up-compare-goal steppe-lancer-set >= 3)
(or	(up-compare-goal war-chariot-set >= 3)
	(up-compare-goal battle-elephant-set >= 3))))))))
=>
	(set-goal temporary-goal9 24922)
	(up-jump-rule 1))
(defrule
(or	(unit-type-count-total konnik-line >= 3)
(or	(unit-type-count-total keshik >= 3)
(or	(unit-type-count-total krepost-konnik-line >= 3)
	(unit-type-count-total leitis-line >= 3))))
=>
	(set-goal temporary-goal9 24922))
(defrule
	(goal temporary-goal9 24922)
	(players-current-age focus-player <= feudal-age)
	(up-compare-goal armytech >= castlea)
	(strategic-number skirms >= 5)
	(strategic-number sn-military-superiority <= 1)
	(strategic-number spears <= 2)
	(strategic-number camels <= 1)
	(strategic-number archers <= 3)
	(strategic-number cavalry <= 1)
	(strategic-number eagles <= 1)
	(strategic-number infantry <= 1)
	(strategic-number moenche <= 0)
	(strategic-number gunpowder <= 1)
	(players-unit-type-count focus-player genoese-crossbowman <= 0)
=>
	(up-modify-sn sn-military-superiority c:+ 1)
	(up-jump-rule 2))
...
(defrule
	...
	(strategic-number cavalry <= 1)
	(strategic-number eagles <= 1)
	(strategic-number infantry <= 2)
	(strategic-number moenche <= 0)
	(players-unit-type-count focus-player genoese-crossbowman <= 0)
=>
	(up-modify-sn sn-military-superiority c:+ 1)); end jumps
...
; tl	(player-valid target-player)
	...
	(population < max-civ-pop)
;	(up-compare-goal gl-threat-time > 12000); 20000
...
(or	(strategic-number teamsuperiority >= 3)
	(strategic-number target-civilian-superiority < -10)))))
=>
	(up-jump-rule 3))
(defrule
...
=>
	(up-modify-sn sn-military-superiority c:- 1)); end jump
...
(defrule
	(strategic-number sn-target-player-number > 0)
=>
	(up-get-focus-fact unit-type-count hippeus-line temporary-goal)
	(up-modify-goal temporary-goal c:max 0)
	(up-modify-goal gl-paphos-uu-count g:= temporary-goal)
	(up-get-focus-fact unit-type-count strategos-line temporary-goal)
	(up-modify-goal gl-paphos-uu-count g:+ temporary-goal)
	(up-get-focus-fact unit-type-count immortal-line temporary-goal)
	(up-modify-goal gl-paphos-uu-count g:+ temporary-goal)
	(up-get-focus-fact unit-type-count companion-line temporary-goal)
	(up-modify-goal gl-paphos-uu-count g:+ temporary-goal)
	(up-get-focus-fact unit-type-count sannahya temporary-goal)
	(up-modify-goal gl-paphos-uu-count g:+ temporary-goal)
	(up-get-focus-fact unit-type-count phalangite-line temporary-goal)
	(up-modify-goal gl-paphos-uu-count g:+ temporary-goal)
	(up-get-focus-fact unit-type-count rhomphaia-line temporary-goal)
	(up-modify-goal gl-paphos-uu-count g:+ temporary-goal)
	(up-get-focus-fact unit-type-count pattiyodha-line temporary-goal)
	(up-modify-goal gl-paphos-uu-count g:+ temporary-goal)
)