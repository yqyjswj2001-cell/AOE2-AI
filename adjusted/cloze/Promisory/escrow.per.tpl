...
(or	(building-type-count shipyard <= 0)
(or	(goal underattack yes)
	(up-research-status c: ri-heavy-arrow-ship != research-available))))
=>
	(up-jump-rule 1))

(defrule
	(unit-type-count-total arrow-ship-line >= {{ESCROW_001}})
(or	(unit-type-count-total arrow-ship-line >= 6)
(or	(goal trainarrowship yes)
(or	(food-amount >= 75)
	(gold-amount >= {{ESCROW_002}}))))
=>
	(up-add-research-cost c: ri-heavy-arrow-ship c: 1)
	(up-modify-flag escrow-flag2 c:+ 32768))

(defrule
(or	(up-compare-goal custom-civ-pop < 32)
(or	(unit-type-count-total arrow-ship-line < 3)
(or	(building-type-count shipyard <= 0)
(or	(goal underattack yes)
...
(or	(goal trainarrowship yes)
(or	(food-amount >= 150)
	(gold-amount >= {{ESCROW_004}}))))
=>
	(up-add-research-cost c: ri-elite-arrow-ship c: 1)
...
(defrule
	(unit-type-count-total ramming-ship-line >= {{ESCROW_005}})
(or	(unit-type-count-total ramming-ship-line >= 6)
(or	(goal trainmonoreme yes)
(or	(wood-amount >= 90)
	(gold-amount >= {{ESCROW_006}}))))
=>
	(up-add-research-cost c: ri-heavy-ramming-ship c: 1)
	(up-modify-flag escrow-flag2 c:+ 65536))

(defrule
(or	(up-compare-goal custom-civ-pop < 25)
(or	(unit-type-count-total ramming-ship-line < 3)
(or	(building-type-count shipyard <= 0)
(or	(goal underattack yes)
...
(defrule
	(unit-type-count-total ramming-ship-line >= {{ESCROW_007}})
(or	(unit-type-count-total ramming-ship-line >= 8)
(or	(goal trainmonoreme yes)
(or	(wood-amount >= 180)
	(gold-amount >= {{ESCROW_008}}))))
	(research-available ri-elite-ramming-ship)
=>
	(up-add-research-cost c: ri-elite-ramming-ship c: 1)
	(up-modify-flag escrow-flag2 c:+ 262144))

(defrule
(or	(up-compare-goal custom-civ-pop < 25)
(or	(unit-type-count-total mangonel-ship-line < 3)
(or	(building-type-count shipyard <= 0)
(or	(goal underattack yes)
	(up-research-status c: ri-heavy-mangonel-ship != research-available)))))
=>
	(up-jump-rule 1))
...
(or	(food-amount >= 350)
	(gold-amount >= {{ESCROW_010}}))))
	(research-available ri-heavy-mangonel-ship)
=>
	(up-add-research-cost c: ri-heavy-mangonel-ship c: 1)
	(up-modify-flag escrow-flag2 c:+ 524288))

(defrule
	(up-compare-flag escrow-flag2 == 32768)
	(can-research-with-escrow ri-heavy-arrow-ship)
=>
	(research ri-heavy-arrow-ship))

(defrule
	(up-compare-flag escrow-flag2 == 131072)
	(can-research-with-escrow ri-elite-arrow-ship)
=>
	(research ri-elite-arrow-ship))

(defrule
	(up-compare-flag escrow-flag2 == 65536)
	(can-research-with-escrow ri-heavy-ramming-ship)
=>
	(research ri-heavy-ramming-ship))

(defrule
	(up-compare-flag escrow-flag2 == 262144)
	(can-research-with-escrow ri-elite-ramming-ship)
=>
...
(defrule
	...
	(can-research-with-escrow ri-heavy-mangonel-ship)
=>
...
;=============================================================
(defrule
	(up-compare-flag escrow-flag3 == 256)
	(can-research-with-escrow ri-elite-war-chariot)
=>
	(research ri-elite-war-chariot))
;=============================================================
(defrule
	(up-compare-flag escrow-flag3 == 512)
	(can-research-with-escrow ri-elite-hoplite)
=>
...
(defrule
	...
	(up-compare-goal custom-civ-pop >= {{ESCROW_020}})
=>
...
=>
	...
	(up-jump-rule 3))
(defrule
	(strategic-number sn-military-superiority >= {{ESCROW_024}})
	(up-compare-goal enemyState <= fcastlea);(players-current-age target-player <= feudal-age)
	(strategic-number target-civilian-superiority >= {{ESCROW_025}}); enemy probably advancing
	(goal attacking no)
	(up-compare-goal total-food-amount >= {{ESCROW_026}}); (food-amount >= 400)
(or	(unit-type-count villager-food >= 15); 18
...
;	(goal strategy r-flush)
	(strategic-number sn-military-superiority >= {{ESCROW_027}}); 2
	(up-compare-goal total-food-amount >= {{ESCROW_028}})
...
(or	(strategic-number sn-military-superiority >= 1); 1
	(up-compare-goal custom-civ-pop >= {{ESCROW_029}}))
...
(or	(up-compare-goal total-gold-amount >= imperial-gold)
	(up-compare-goal custom-civ-pop >= {{ESCROW_031}})))
	(up-compare-goal custom-civ-pop >= {{ESCROW_032}})
=>
...
(defrule
	(goal milunits no)
(or	(up-compare-goal total-food-amount >= imperial-food)
	(unit-type-count villager-food >= {{ESCROW_033}}))
(or	(up-compare-goal total-gold-amount >= imperial-gold)
(or	(unit-type-count villager-gold >= 7)
	(up-compare-goal tradeunits >= 18)))
	(up-compare-goal custom-civ-pop >= {{ESCROW_034}})
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 10))
...
(or	(up-compare-goal total-food-amount >= imperial-food)
	(unit-type-count villager-food >= {{ESCROW_035}}))
(or	(up-compare-goal total-gold-amount >= imperial-gold)
(or	(unit-type-count villager-gold >= 6)
	(up-compare-goal tradeunits >= 18)))
	(up-compare-goal custom-civ-pop >= {{ESCROW_036}})
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 9))
...
(or	(unit-type-count-total villager >= 8)
	(building-type-count-total town-center >= {{ESCROW_037}}))))
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 8))
...
;	(up-compare-goal total-gold-amount >= imperial-gs)); test
	(unit-type-count villager-food >= {{ESCROW_040}})
(or	(up-compare-goal total-gold-amount >= imperial-gold)
(or	(unit-type-count villager-gold >= 7)
	(up-compare-goal tradeunits >= 18)))
	(up-compare-goal custom-civ-pop >= {{ESCROW_041}})
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 6))
(defrule
	(strategic-number sn-military-superiority >= {{ESCROW_042}})
	(up-enemy-units-in-town < 5)
(or	(up-compare-goal total-food-amount >= imperial-food)
	(unit-type-count villager-food >= {{ESCROW_043}})); should be able to afford it quite easily
(or	(up-compare-goal total-gold-amount >= imperial-gold)
(or	(unit-type-count villager-gold >= 7)
	(up-compare-goal tradeunits >= 18)))
	(up-compare-goal custom-civ-pop >= {{ESCROW_044}})
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 5))
(defrule
	(strategic-number sn-military-superiority >= {{ESCROW_045}}); 0
(or	(up-compare-goal total-food-amount >= imperial-food)
	(unit-type-count villager-food >= {{ESCROW_046}}))
(or	(up-compare-goal total-gold-amount >= imperial-gold)
(or	(unit-type-count villager-gold >= 7)
	(up-compare-goal tradeunits >= 18)))
	(up-compare-goal custom-civ-pop >= {{ESCROW_047}})
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 4))
...
(or	(up-compare-goal total-food-amount >= imperial-food)
	(unit-type-count villager-food >= {{ESCROW_048}})); ^
(or	(up-compare-goal total-gold-amount >= imperial-gold)
(or	(unit-type-count villager-gold >= 7)
(or	(up-compare-goal tradeunits >= 18)
	(up-compare-goal relic-count >= 4))))
;	(up-enemy-units-in-town < 5)
	(up-compare-goal custom-civ-pop >= {{ESCROW_049}})
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 3))
(defrule
	(strategic-number sn-military-superiority >= {{ESCROW_050}}); 1
...
=>
	...
	(up-jump-rule 2))
(defrule
	(strategic-number sn-military-superiority >= {{ESCROW_051}}); -1
(or	(up-compare-goal enemyState >= cimperial);	(players-current-age target-player >= imperial-age)
	(strategic-number sn-military-superiority >= {{ESCROW_052}})); 0
	(up-compare-goal custom-civ-pop >= up-max-civ)
(or	(population >= 190)
	(population >= max-civ-pop))
	(unit-type-count villager-food >= {{ESCROW_053}})
	(unit-type-count villager-gold >= {{ESCROW_054}})
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2)
	(up-jump-rule 1))
(defrule
	(strategic-number sn-military-superiority >= {{ESCROW_055}})
;	(goal strategy usual)
(or	(up-compare-goal total-food-amount >= imperial-food)
	(unit-type-count villager-food >= {{ESCROW_056}})); 32
(or	(up-compare-goal total-gold-amount >= imperial-gold)
(or	(unit-type-count villager-gold >= 7)
	(up-compare-goal tradeunits >= 18)))
(or	(up-compare-goal custom-civ-pop >= 90)
	(strategic-number sn-military-superiority >= {{ESCROW_057}}))
=>
	(up-add-research-cost c: imperial-age c: 1)
	(up-modify-flag escrow-flag c:+ 2))
#end-if
...
=>
	(up-jump-rule 5))
(defrule
	(up-compare-goal total-food-amount >= {{ESCROW_058}}); 700
	(gold-amount >= {{ESCROW_059}})
...
(or	(and	(unit-type-count-total villager < 36); 35
		(up-compare-goal total-food-amount < {{ESCROW_064}}))
	(unit-type-count-total villager < {{ESCROW_065}}))
	(unit-type-count villager-food < {{ESCROW_066}})
=>
	(up-jump-rule 1))
(defrule
(or	(unit-type-count-total villager >= 39); 38
(or	(players-military-population target-player < 2)
	(strategic-number sn-military-superiority >= {{ESCROW_067}}))); 1
(or	(unit-type-count-total villager >= 39); 38
...
(or	(and	(building-type-count town-center <= 1)
		(unit-type-count-total villager < {{ESCROW_072}}))
(or	(goal underattack yes)
...
(or	(up-compare-goal excessWood >= 200); + food-amount >= 100 below
	(strategic-number sn-military-superiority >= {{ESCROW_073}}))))
(or	(unit-type-count-total villager >= 70)
	(up-compare-goal excessFood >= {{ESCROW_074}})); 120
	(unit-type-count-total villager >= {{ESCROW_075}})
=>
...
(or	(and	(food-amount < db-food-buffer); (up-compare-goal total-food-amount < db-food-buffer)
	...
	(and	(up-research-status c: castle-age != research-available)
		(and	(building-type-count-total blacksmith <= 0)
			(and	(wood-amount < 200)
				(unit-type-count-total villager < {{ESCROW_076}})))))
=>
	(up-jump-rule 3))
(defrule
...
(or	(players-military-population target-player < 2)
	(strategic-number sn-military-superiority >= {{ESCROW_077}})))); 1
	(unit-type-count-total villager >= {{ESCROW_078}}); 22
=>
...
(or	(goal strategy sling)
	(strategic-number sn-current-age >= fcastlea)));)
	(unit-type-count-total villager >= {{ESCROW_079}}); 20
=>
	(up-add-research-cost c: ri-double-bit-axe c: 1)
	(up-modify-flag escrow-flag2 c:+ 1))
(defrule
...
(or	(unit-type-count-total villager >= 30); 33
	(strategic-number sn-military-superiority >= {{ESCROW_080}})))
...
(or	(unit-type-count-total villager >= 30); 33
(or	(players-military-population target-player < 2)
	(strategic-number sn-military-superiority >= {{ESCROW_081}}))); 1
...
(or	(unit-type-count villager-forager g:<= forage-count)
	(building-type-count-total farm >= {{ESCROW_084}}))
	(current-age <= feudal-age)
	(up-compare-goal total-food-amount < {{ESCROW_085}}); 175
	(current-age-time < {{ESCROW_086}})
...
=>
	(up-jump-rule 7)); !
(defrule
	(unit-type-count fishing-ship >= {{ESCROW_087}})
	(unit-type-count villager < {{ESCROW_088}})
	(wood-amount < {{ESCROW_089}})
	(strategic-number sn-food-gatherer-percentage <= {{ESCROW_090}})
(or	(up-compare-goal strategy-type2 == water)
	(strategic-number sn-food-gatherer-percentage <= {{ESCROW_091}}))
...
;(or
	(and	(unit-type-count fishing-ship >= 7)
		(unit-type-count villager < {{ESCROW_092}}))
...
(defrule
	...
	(unit-type-count villager-forager >= {{ESCROW_093}});
	(strategic-number sn-current-age < fcastlea)
	(building-type-count-total farm < {{ESCROW_094}}); test
;(or
...
(or	(players-military-population target-player < 2)
	(strategic-number sn-military-superiority >= {{ESCROW_100}})))); 1
	(unit-type-count-total villager >= {{ESCROW_101}}); 30
=>
...
=>
	(up-jump-rule 3))
(defrule
	(building-type-count-total town-center <= {{ESCROW_111}})
	(up-compare-goal custom-civ-pop < {{ESCROW_112}}); 60
	(up-compare-goal custom-civ-pop < up-max-civ)
	(population < max-civ-pop)
	(wood-amount < {{ESCROW_113}})
	(stone-amount >= tc-stone)
	(current-age-time < {{ESCROW_114}})
; ?	(up-research-status c: ri-hand-cart <= research-available)
=>
	(up-jump-rule 2))
(defrule
...
=>
	...
	(up-jump-rule 1))
(defrule
	(unit-type-count-total villager >= {{ESCROW_116}}); 52
(or	(wood-amount >= 400)
(or	(goal dreitc yes); (building-type-count-total town-center >= 3)
...
=>
	(up-jump-rule 2))
(defrule
	(unit-type-count-total militiaman-line >= {{ESCROW_130}}); 4
(or	(goal maa-var yes)
...
(or	(goal trainchamp yes)
	(unit-type-count-total militiaman-line >= {{ESCROW_131}}))))
=>
...
(or	(up-research-status c: ri-supplies >= research-pending)
	(unit-type-count-total militiaman-line >= {{ESCROW_132}})))
=>
	(up-add-research-cost c: ri-man-at-arms c: 1)
	(up-modify-flag escrow-flag c:+ 512))
(defrule
...
=>
	(up-jump-rule 1))
(defrule
	(unit-type-count-total militiaman-line >= {{ESCROW_134}})
(or	(goal champgoal yes)
(or	(goal enemy-goal2 klew)
(or	(goal trainchamp yes)
	(unit-type-count-total militiaman-line >= {{ESCROW_135}}))))
=>
...
(or	(and	(goal trainchamp yes)
		(or	(goal enemy-goal2 klew)
			(unit-type-count-total militiaman-line >= {{ESCROW_137}})))
	(unit-type-count-total militiaman-line >= {{ESCROW_138}})))
=>
...
(or	(and	(goal trainchamp yes)
		(or	(goal enemy-goal2 klew)
			(unit-type-count-total militiaman-line >= {{ESCROW_140}})))
	(unit-type-count-total militiaman-line >= {{ESCROW_141}})))
=>
...
(defrule
	(goal palagoal yes)
	(unit-type-count-total knight-line >= {{ESCROW_151}}); hmm
...
(or	(up-research-status c: ri-lechitic-legacy >= research-pending)
	(and	(goal trainhussar yes)
		(unit-type-count-total scout-cavalry-line >= {{ESCROW_153}})))); 3
=>
...
(defrule
	(civ-selected mongol)
	(goal underattack no)
	(unit-type-count-total scout-cavalry-line >= {{ESCROW_157}}); 8
...
(or	(and	(goal trainhussar yes)
		(unit-type-count-total scout-cavalry-line >= {{ESCROW_158}}))
...
(or	(and	(up-research-status c: ri-fletching == research-available)
	...
	(and	(up-compare-goal custom-civ-pop < up-max-civ)
		(up-compare-goal custom-civ-pop < {{ESCROW_160}})))))
=>
	(up-jump-rule 2))
(defrule
...
(or	(goal strategy r-flush)
	...
	(unit-type-count-total archer-line >= {{ESCROW_161}})
=>
...
(or	(up-compare-goal tradeunits >= 6)
	...
	(goal underattack no)
	(unit-type-count-total archer-line >= {{ESCROW_162}})
=>
	(up-add-research-cost c: ri-crossbow c: 1)
	(up-modify-flag escrow-flag c:+ 524288))
(defrule
...
(or	(up-research-status c: ri-bodkin-arrow == research-available)
	(and	(up-compare-goal custom-civ-pop < up-max-civ)
		(up-compare-goal custom-civ-pop < {{ESCROW_163}}))))))
=>
	(up-jump-rule 1))
(defrule
...
(or	(up-compare-goal tradeunits >= 12)
	...
	(unit-type-count-total archer-line >= {{ESCROW_164}})
=>
...
(or	(goal trainskirm yes)
	(unit-type-count-total skirmisher-line >= {{ESCROW_165}})); 10
=>
...
(or	(unit-type-count-total cavalry-archer-line >= 10)
	...
	(unit-type-count-total cavalry-archer-line >= {{ESCROW_167}})
=>
...
(or	(and	(goal enemy-goal rush)
		(or	(players-building-type-count focus-player stable >= 2)
			(strategic-number cavalry >= {{ESCROW_169}})))
(or	(cc-players-unit-type-count 0 gold-mine < 6)
(or	(and	(goal trainpike yes)
		(unit-type-count-total spearman-line >= {{ESCROW_170}})); 3
	(unit-type-count-total spearman-line >= {{ESCROW_171}})))); 7
=>
...
(or	(up-unit-type-in-town c: war-chariot >= 4)
...
(defrule
	(goal trainpike no)
	(unit-type-count-total spearman-line < {{ESCROW_173}})
	(goal underattack no)
(or	(and	(up-compare-flag escrow-flag == 4)
		(unit-type-count-total my-unique-unit-line >= {{ESCROW_174}}))
	(and	(up-compare-flag escrow-flag == 32768)
		(unit-type-count-total knight-line >= {{ESCROW_175}})))
=>
	(up-jump-rule 1))
(defrule
(or	(cc-players-unit-type-count 0 gold-mine < 6)
(or	(and	(goal trainpike yes)
		(unit-type-count-total spearman-line >= {{ESCROW_176}}))
	(unit-type-count-total spearman-line >= {{ESCROW_177}})))
=>
...
(or	(unit-type-count villager-wood >= 22)
	(wood-amount >= {{ESCROW_178}}))
(or	(unit-type-count villager-food >= 20)
	(food-amount >= {{ESCROW_179}}))
...
(or	(strategic-number sn-current-age >= fcastlea)
	(and	(up-compare-goal strategy-type <= feudal-war)
		(up-compare-goal my-mpop >= {{ESCROW_196}})))
=>
...
=>
	(up-jump-rule 2))
(defrule
	(unit-type-count-total imperial-camel < {{ESCROW_198}})
	(unit-type-count-total scout-cavalry-class < {{ESCROW_199}})
	(unit-type-count-total cavalry-class < {{ESCROW_200}})
	(unit-type-count-total magyar-huszar < {{ESCROW_201}})
	(unit-type-count-total boyar < {{ESCROW_202}})
	(up-compare-goal battle-elephant-set < 7)
	(up-compare-goal steppe-lancer-set < 7)
	(up-compare-goal war-chariot-set < 7)
(nand	(goal palagoal yes)
	(strategic-number sn-current-age >= imperial))
=>
	(up-jump-rule 1))
...
(or	(strategic-number sn-current-age >= fcastlea)
	(and	(up-compare-goal strategy-type <= feudal-war)
		(up-compare-goal my-mpop >= {{ESCROW_203}})))
=>
...
=>
	(up-jump-rule 2))
(defrule
	(unit-type-count-total imperial-camel < {{ESCROW_205}})
	(unit-type-count-total scout-cavalry-class < {{ESCROW_206}})
	(unit-type-count-total cavalry-class < {{ESCROW_207}})
	(unit-type-count-total magyar-huszar < {{ESCROW_208}})
	(unit-type-count-total boyar < {{ESCROW_209}})
	(up-compare-goal battle-elephant-set < 10)
	(up-compare-goal steppe-lancer-set < 10)
	(up-compare-goal war-chariot-set < 10)
(nand	(goal palagoal yes)
	(strategic-number sn-current-age >= imperial))
=>
	(up-jump-rule 1))
...
=>
	(up-jump-rule 2))
(defrule
	(unit-type-count-total imperial-camel < {{ESCROW_211}})
	(unit-type-count-total scout-cavalry-class < {{ESCROW_212}})
	(unit-type-count-total cavalry-class < {{ESCROW_213}})
	(unit-type-count-total magyar-huszar < {{ESCROW_214}})
	(unit-type-count-total boyar < {{ESCROW_215}})
	(up-compare-goal battle-elephant-set < 12)
	(up-compare-goal steppe-lancer-set < 12)
	(up-compare-goal war-chariot-set < 12)
=>
	(up-jump-rule 1))
(defrule
	(up-compare-flag escrow-flag != 4)
...
;(or	(goal strategy r-flush)
;	(goal strategy a-rush))
	(unit-type-count-total archery-class < {{ESCROW_222}}); 6
	(unit-type-count-total cavalry-archer-class < {{ESCROW_223}}); 6
	(up-compare-goal custom-civ-pop < {{ESCROW_224}}); 33
	(unit-type-count-total villager-food < {{ESCROW_225}})
	(up-compare-goal total-food-amount < {{ESCROW_226}})
	(food-amount < {{ESCROW_227}})
...
(or	(unit-type-count-total archery-class >= 3)
	(unit-type-count-total cavalry-archer-class >= {{ESCROW_228}}))
=>
...
(or	(goal strategy a-rush)
	(goal strategy ca-rush)))))
(or	(unit-type-count-total archery-class >= 3)
	(unit-type-count-total cavalry-archer-class >= {{ESCROW_237}}))
=>
...
(or	(goal strategy a-rush)
	(goal strategy ca-rush)))))
(or	(unit-type-count-total archery-class >= 3)
	(unit-type-count-total cavalry-archer-class >= {{ESCROW_247}}))
=>
...
(or	(not	(civ-selected spanish))
	(goal uugoal no))
	(strategic-number spears >= {{ESCROW_250}}); 12
=>
	(up-add-research-cost c: ri-chemistry c: 1)
	(up-modify-flag escrow-flag2 c:+ 1024)
...
(or	(unit-type-count-total arrow-ship-line >= 21)
	(unit-type-count-total galley-line >= {{ESCROW_253}}))))))
=>
	(up-add-research-cost c: ri-chemistry c: 1)
...
(or	(unit-type-count-total arrow-ship-line >= 21)
	(unit-type-count-total longboat-line >= {{ESCROW_255}}))))))
=>
...
=>
	(up-jump-rule 1))
(defrule
	(unit-type-count-total infantry-class >= {{ESCROW_257}})
(or	(and	(strategic-number sn-current-age >= imperial)
		(goal champgoal yes))
(or	(and	(strategic-number sn-current-age >= imperial)
		(goal strategy stonewall))
	(unit-type-count-total infantry-class >= {{ESCROW_258}})))
=>
...
=>
	(up-jump-rule 1))
(defrule
	(unit-type-count-total infantry-class >= {{ESCROW_260}})
(or	(and	(strategic-number sn-current-age >= imperial)
		(goal champgoal yes))
(or	(and	(strategic-number sn-current-age >= imperial)
		(goal strategy stonewall))
	(unit-type-count-total infantry-class >= {{ESCROW_261}})))
=>
...
(or	(unit-type-count-total demolition-ship-line >= 3)
	(and	(goal traingalley yes)
		(unit-type-count-total galley-line >= {{ESCROW_266}})))))))
=>
...
=>
	(up-jump-rule 1))
(defrule
	(unit-type-count-total fire-ship-line >= {{ESCROW_269}}); 4
(or	(unit-type-count-total fire-ship-line >= 9)
(or	(goal trainfire yes)
(or	(wood-amount >= 280)
	(gold-amount >= {{ESCROW_270}}))))
...
=>
	...
	(up-jump-rule 4))
(defrule
	(game-time >= {{ESCROW_278}}); DM
	(goal underattack no)
(or	(wood-amount >= 1100)
(or	(and	(food-amount < 100)
		(gold-amount >= {{ESCROW_279}}))
	(and	(food-amount >= 1100)
		(gold-amount < {{ESCROW_280}}))))
=>
	(up-add-object-cost c: market c: 1)
	(up-modify-flag escrow-flag2 c:+ 1048576)
	(up-jump-rule 3))
...
(or	(goal strategy krush)
	...
	(building-type-count-total town-center < {{ESCROW_285}})
	(players-building-type-count target-player stone-wall-line < {{ESCROW_286}})
(nand	(strategic-number sn-maximum-town-size < 40)
	(or	(and	(up-unit-type-in-town c: archer-line >= 5)
			(military-population < {{ESCROW_287}}))
...
(or	(goal attacking no)
	(strategic-number teamsuperiority <= {{ESCROW_288}}))
=>
	(up-jump-rule 12))
(defrule
	(up-compare-goal strategy-type s:<= sn-current-age)
	(goal position-goal flank)
	(strategic-number sn-military-superiority >= {{ESCROW_289}})
	(military-population >= {{ESCROW_290}})
	(up-compare-goal target-mpop <= {{ESCROW_291}})
	(up-compare-goal enemyState <= feudal)
	(goal underattack no)
	(goal defend no)
(or	(players-building-type-count target-player watch-tower >= 2); 3
	(players-building-type-count target-player market >= {{ESCROW_292}}))
=>
...
(or	(and	(goal underattack yes)
		(strategic-number archers >= {{ESCROW_298}}))
	(up-unit-type-in-town c: archer-line >= 10))
(or	(strategic-number sn-military-superiority <= -1)
	(strategic-number teamsuperiority <= {{ESCROW_299}}))
	(up-compare-goal skirmisher-set < 8)
	(unit-type-count-total huskarl-set < {{ESCROW_300}})
=>
	(up-add-object-cost c: siege-workshop c: 1)
	(up-modify-flag escrow-flag2 c:+ 2097153)
	(set-goal increase-ts 0)
...
(defrule
	(strategic-number sn-current-age >= imperial)
	(strategic-number sn-military-superiority >= {{ESCROW_301}})
	(population >= up-max-civ)
	(building-type-count-total castle < {{ESCROW_302}})
=>
	(up-add-object-cost c: siege-workshop c: 1)
	(up-modify-flag escrow-flag2 c:+ 2097153)
	(set-goal increase-ts 0)
...
(defrule
	(goal position-goal flank)
	(strategic-number skirmsarchers >= {{ESCROW_303}})
	(strategic-number infantry < {{ESCROW_304}})
	(strategic-number cavalry < {{ESCROW_305}})
	(building-type-count castle < {{ESCROW_306}}); test
	(strategic-number sn-military-superiority <= {{ESCROW_307}})
(or	(strategic-number sn-military-superiority <= -1)
	(up-compare-flag escrow-flag2 != 524288))
...
(or	(players-building-type-count target-player siege-workshop >= 2)
	(players-unit-type-count focus-player scorpion-line >= {{ESCROW_308}}))
(or	(goal enemy-goal rush)
	(players-unit-type-count focus-player scorpion-line >= {{ESCROW_309}}))
=>
	(up-add-object-cost c: siege-workshop c: 1)
	(up-modify-flag escrow-flag2 c:+ 2097153)
	(set-goal increase-ts 0)
...
(defrule
	(goal enemy-goal2 klew)
	(building-type-count-total town-center >= {{ESCROW_340}})
	(strategic-number sn-military-superiority <= {{ESCROW_341}})
	(up-compare-goal excessFood < {{ESCROW_342}})
	(up-compare-goal custom-civ-pop < {{ESCROW_343}})
=>
	(up-jump-rule 20))
(defrule
...
(or	(and	(up-compare-const dm-game == 1)
		(and	(game-time < 210)
			(unit-type-count-total villager < {{ESCROW_350}})))
		...
		(and	(wood-amount < tc-wood)
			(and	(building-type-count-total farm g:< maxfarms)
				(and	(up-compare-goal excessFood < 100)
					(unit-type-count villager-food < {{ESCROW_351}})))))); 18
=>
	(up-jump-rule 13))
(defrule
...
;	(goal milunits yes)
	(building-type-count-total town-center < {{ESCROW_357}})
...
(defrule
	...
	(building-type-count-total town-center < {{ESCROW_358}})
...
(or	(goal milunits no)
	;(and	(goal milunits yes)
		(building-type-count-total farm >= {{ESCROW_359}}));)
	(building-type-count-total town-center < {{ESCROW_360}}); 4
(or	(unit-type-count villager-wood >= 11); 14; 15
	(wood-amount >= tc-wood))
(or	(unit-type-count villager-stone >= 3)
	(up-compare-goal total-stone-amount >= tc-stone))
...
(defrule
	(goal strategy r-flush)
	(building-type-count-total town-center < {{ESCROW_363}})
	(building-type-count-total archery-range >= {{ESCROW_364}})
	(strategic-number sn-military-superiority >= {{ESCROW_365}})
	(unit-type-count villager-wood >= {{ESCROW_366}}); 14; 15
;(or	(unit-type-count villager-stone >= 3)
	(up-compare-goal total-stone-amount >= tc-stone);)
=>
	(up-add-object-cost c: town-center-foundation c: 1)
...
(defrule
	...
	(building-type-count-total town-center < {{ESCROW_367}})
	(building-type-count-total stable >= {{ESCROW_368}}); 2
	(strategic-number sn-military-superiority >= {{ESCROW_369}})
	(unit-type-count villager-wood >= {{ESCROW_370}}); 14; 15
;(or	(unit-type-count villager-stone >= 3)
	(up-compare-goal total-stone-amount >= tc-stone);)
=>
	(up-add-object-cost c: town-center-foundation c: 1)
...
(defrule
	(goal strategy a-rush)
	(building-type-count-total town-center < {{ESCROW_371}})
	(building-type-count-total archery-range >= {{ESCROW_372}}); 3
(or	(strategic-number sn-military-superiority >= 0); 1
	(up-compare-goal custom-civ-pop >= {{ESCROW_373}})); 36
(or	(unit-type-count villager-wood >= 11); 14; 15
	(wood-amount >= tc-wood))
;(or	(unit-type-count villager-stone >= 3)
	(up-compare-goal total-stone-amount >= tc-stone);)
...
(defrule
	...
	(strategic-number ep-civilian-superiority >= {{ESCROW_374}}); 2
	(strategic-number ep-military-superiority <= {{ESCROW_375}})
	(building-type-count-total town-center >= {{ESCROW_376}})
	(building-type-count-total stable < {{ESCROW_377}})
	(unit-type-count villager-wood < {{ESCROW_378}}); 18
	(wood-amount < tc-wood); maybe disable anyway
	(food-amount < {{ESCROW_379}})
=>
	(up-jump-rule 3))
(defrule
	(goal strategy krush)
	(up-compare-goal kr-var <= 1)
	(building-type-count-total town-center < {{ESCROW_380}})
	(building-type-count-total stable >= {{ESCROW_381}})
...
(defrule
	(goal strategy krush)
	(building-type-count-total town-center < {{ESCROW_382}})
	(building-type-count-total stable >= {{ESCROW_383}})
	(military-population >= {{ESCROW_384}}); 7
(or	(strategic-number sn-military-superiority >= 0); 1
...
(defrule
	(goal strategy krush)
	(building-type-count-total town-center < {{ESCROW_385}}); 3
	(building-type-count-total stable >= {{ESCROW_386}})
	(up-compare-goal custom-civ-pop >= {{ESCROW_387}})
...
; hm	(strategic-number target-civilian-superiority <= -5)
	(goal enemy-goal 0)
	(strategic-number skirmsarchers < {{ESCROW_393}})
	(up-enemy-units-in-town < 4)
	(strategic-number sn-military-superiority >= {{ESCROW_394}})
=>
	(up-jump-rule 6))
(defrule
...
(or	(and	(or	(strategic-number skirmsarchers < 16)
		...
		(strategic-number sn-military-superiority >= {{ESCROW_395}}))
(or	(up-research-status c: imperial-age >= research-pending)
...
(or	(up-compare-goal tradeunits >= 9)
	(unit-type-count villager-gold >= {{ESCROW_398}})))
(or	(wood-amount >= 160)
	(unit-type-count villager-wood >= {{ESCROW_399}}))
;(or	(up-compare-goal enemy-goal != 0); needs to have archers anyway
(or	(strategic-number skirmsarchers >= 14)
	(strategic-number archers >= {{ESCROW_400}}))
=>
...
(or	(gold-amount >= 135)
(or	(up-compare-goal tradeunits >= 6)
	(unit-type-count villager-gold >= {{ESCROW_401}})))
(or	(wood-amount >= 160)
	(unit-type-count villager-wood >= {{ESCROW_402}}))
...
(or	(up-compare-goal ttower-distance < 30)
	...
	(players-building-type-count target-player watch-tower >= {{ESCROW_403}})
	(up-projectile-detected projectile-watch-tower < 30000)
	(unit-type-count-total bombard-cannon-line <= {{ESCROW_404}})
	(unit-type-count-total trebuchet-set <= {{ESCROW_405}})
=>
	(up-add-object-cost c: mangonel c: 1)
	(up-modify-flag escrow-flag2 c:+ 8388608))
;=============================================================
...
=>
	(up-jump-rule 2))
(defrule
	(unit-type-count-total monk <= {{ESCROW_407}})
...
=>
	(up-jump-rule 2))
(defrule
	(unit-type-count-total archery-class < {{ESCROW_417}})
	(unit-type-count-total cavalry-archer-class < {{ESCROW_418}})
	(up-compare-goal skirmisher-set < 21)
	(unit-type-count-total cavalry-archer-line < {{ESCROW_419}})
	(unit-type-count-total elephant-archer < {{ESCROW_420}})
	(unit-type-count-total slinger < {{ESCROW_421}})
	(unit-type-count-total genoese-crossbowman < {{ESCROW_422}})
	(unit-type-count-total rattan-archer < {{ESCROW_423}})
	(unit-type-count-total elite-rattan-archer < {{ESCROW_424}})
	(unit-type-count-total camel-archer < {{ESCROW_425}})
	(unit-type-count-total elite-camel-archer < {{ESCROW_426}})
=>
	(up-jump-rule 1))
(defrule
...
(or	(and	(up-compare-goal custom-civ-pop < 20)
		(up-compare-goal excessGold < {{ESCROW_431}}))
	(goal underattack yes)))))
=>
	(up-jump-rule 1))
(defrule
...
=>
	(up-jump-rule 3))
(defrule
	(players-building-type-count every-enemy castle <= {{ESCROW_433}})
	(players-building-type-count every-enemy krepost <= {{ESCROW_434}})
	(players-building-type-count every-enemy bombard-tower <= {{ESCROW_435}})
	(players-building-type-count every-enemy watch-tower <= {{ESCROW_436}})
	(players-building-type-count every-enemy stone-wall-line <= {{ESCROW_437}})
...
(or	(up-compare-goal custom-civ-pop >= up-max-civ)
	(population >= max-civ-pop)))
	(unit-type-count-total trebuchet-set < {{ESCROW_439}})
=>
...
(or	(goal trainbombard yes)
	(unit-type-count-total bombard-cannon-line >= {{ESCROW_445}}))
	(unit-type-count-total bombard-cannon-line >= {{ESCROW_446}})
=>
...
(defrule
(or	(goal trainchariot yes)
	(up-compare-goal war-chariot-set >= 15))
	(up-compare-goal war-chariot-set >= 6)
=>
	(up-add-research-cost c: ri-elite-war-chariot c: 1)
	(up-modify-flag escrow-flag3 c:+ 256)); end jump
;=============================================================
(defrule
(or	(and	(up-compare-goal custom-civ-pop < up-max-civ)
...
(or	(goal trainhoplite yes)
	...
	(up-compare-goal hoplite-set >= 8)
=>
	(up-add-research-cost c: ri-elite-hoplite c: 1)
	(up-modify-flag escrow-flag3 c:+ 512)); end jump
;=============================================================
;
; Redo
;
