...
(defrule
	...
	;(dropsite-min-distance wood < 15);stragglers available
...
=>
	(set-strategic-number sn-preferred-settlement-placement 3);wood
	(set-goal lock-settlement-placement yes)
	;(chat-to-player my-player-number "Wood settlement .1")
	(build settlement)
)
...
(defrule
	...
	(or(dropsite-min-distance food > 3)
	(and(game-time > 400)
	(or(unit-type-count-total villager-shepherd > 0)
	(unit-type-count-total villager-hunter > 0)))))
	(dropsite-min-distance food < 255)
	(or(building-type-count-total settlement > 0)
...
=>
	...
	(set-goal lock-settlement-placement yes)
	;(chat-to-player my-player-number "Food settlement .1")
	(build settlement)
	(up-jump-rule 500)
)
...
(defrule
	...
	(building-type-count-total town-center > 0)
	(building-type-count-total settlement < {{BUILDINGS_SETTLEMENT_005}})
...
(defrule
	...
	(game-time < 600)
	(building-type-count-total town-center < 1)
	(building-type-count-total town-center-foundation < 1)
	(wood-amount > 275)
	(stone-amount > 100)
=>
	(up-full-reset-search)
...
=>
	...
	;(chat-local-to-self "move villager")
	(disable-self)
)
#end-if
(defrule ; debug rule
...
(not	(stance-toward focus-player ally))
	(player-valid focus-player)
	(up-compare-goal temporary-goal < 240);sanity check
=>
...
;	(up-bound-point saved-point-x saved-point-x);sanity check
	(up-jump-rule -1))
(defrule
...
;------------------------------------------------------------------------
;Port placement rules (adapted from Dock)
(defrule
(or	(up-compare-goal migration-state != 1)
(or	(unit-type-count transport-ship >= 1)
...
=>
	...
	(up-bound-precise-point saved-point-x 0 c: 4))
(defrule
(not	(up-can-build-line escrow-state point-x c: port))
	(up-point-distance point-x saved-point-x >= 4)
=>
	(up-lerp-tiles point-x saved-point-x c: 1)
	(up-jump-rule -1))
...
=>
	...
	(up-jump-rule -3))
(defrule
	(up-can-build-line escrow-state point-x c: port)
=>
...
(defrule
	...
	(game-time >= 48)
=>
	(build port)); end jumps
;------------------------------------------------------------------------

;Shipyard placement rules (adapted from Dock)
(defrule
(or	(up-compare-goal migration-state != 1)
(or	(unit-type-count transport-ship >= 1)
...
=>
	...
	(up-bound-precise-point saved-point-x 0 c: 4))
(defrule
(not	(up-can-build-line escrow-state point-x c: shipyard))
	(up-point-distance point-x saved-point-x >= 4)
=>
	(up-lerp-tiles point-x saved-point-x c: 1)
	(up-jump-rule -1))
...
=>
	...
	(up-jump-rule -3))
(defrule
	(up-can-build-line escrow-state point-x c: shipyard)
=>
	(up-build-line point-x point-x c: shipyard)
	(up-jump-rule 1))
(defrule
(not	(up-can-build-line escrow-state point-x c: shipyard))
	(can-build shipyard)
...
=>
	...
	; (chat-to-player 1 "build house 2")
	(up-jump-rule 6))
(defrule
	(goal temporary-goal 1)
...
=>
	...
	(up-bound-point point-x point-x);sanity check
	(up-bound-point saved-point-x saved-point-x)
	(up-jump-rule -2))
(defrule
	(goal temporary-goal 1)
...
(defrule
	...
	(housing-headroom < 5)
(or	(building-type-count-total dock >= 1)
(or (building-type-count-total port >= 1)
...
(defrule
	(up-pending-objects c: house < 2)
	(goal increase-ts 0)
	(building-type-count-total port >= 2)
(or	(housing-headroom < 8)
	(building-type-count-total port >= 3))
(or	(housing-headroom < 10)
	(building-type-count-total port >= 4))
	(housing-headroom < 12)
=>
	(set-goal increase-ts house)
	(enable-timer increase-ts-timer 7))
...
(defrule
	(goal temporary-goal6 1248812)
=>
	(up-modify-sn sn-focus-player-number g:= temporary-goal));was up-modify-goal, probably a mistake?
#end-if
...
;	(true);Debug rule
;=>
;	(chat-to-player my-player-number "Sufficient wood found")
;	)
...
=>
	(up-full-reset-search)
	(up-find-local c: male-lumberjack c: 10)
	(up-find-local c: female-lumberjack c: 10)
	(up-set-target-point position-self-x)
	(up-clean-search search-local object-data-distance search-order-desc)
	(up-set-target-object search-local c: 1);2nd furthest
...
=>
	...
	(set-strategic-number sn-want-m-camp yes)
(set-strategic-number sn-camp-type gold)); end jump
...
(defrule
    ...
    (strategic-number sn-camp-type == gold)
=>
    (up-full-reset-search)
;    (up-filter-distance c: 5 s: sn-camp-max-distance)
    (up-set-target-point position-self-x)
    (up-modify-goal temporary-goal8 s:= sn-camp-max-distance)
    (up-modify-goal temporary-goal8 c:+ 5)
    (up-filter-distance c: 5 g: temporary-goal8)
    (up-filter-status c: status-resource c: list-active)
    (up-find-resource c: gold c: 40)
    (set-goal temporary-goal 0);current index
    (set-goal temporary-goal2 -1);optimum index
    (set-goal temporary-goal3 0);current score
    (set-goal temporary-goal4 -999);optimum score
    (set-goal temporary-goal5 45);max search tries
)
...
;    (up-filter-distance c: 5 s: sn-camp-max-distance)
    (up-set-target-point position-self-x)
    (up-modify-goal temporary-goal8 s:= sn-camp-max-distance)
    (up-modify-goal temporary-goal8 c:+ 4);5
    (up-filter-distance c: 5 g: temporary-goal8)
    (up-filter-status c: status-resource c: list-active)
...
=>
    (up-get-point position-object point-x)
    (up-set-target-point point-x)
    (up-get-point-distance point-x position-self-x temporary-goal6)
...
(defrule
    ...
    (up-modify-goal temporary-goal c:+ 2);for peformance reasons
    (up-set-target-object search-remote g: temporary-goal)
    (strategic-number sn-want-m-camp == yes)
=>
    (up-modify-goal temporary-goal5 g:- 1)
    (set-goal temporary-goal3 0)
    (up-jump-rule -4)
)
...
=>
    (up-get-point position-object point-x)
    (set-goal temporary-goal7 23456)
    (up-lerp-tiles point-x position-self-x c: 2)
	(up-get-point-zone point-x temporary-goal5)
)
...
=>
	(up-get-point position-object point-x)
;    (up-send-flare point-x)
;    (up-get-point position-self position-self-x);remove when copying to promi
...
=>
	(up-full-reset-search)
	(up-set-target-point position-self-x)
	(up-filter-distance c: 12 c: 25)
	(up-find-resource c: wild-chicken-a c: 10)
	(up-find-resource c: wild-chicken-b c: 10)
	(up-find-resource c: wild-chicken-c c: 10)
	(up-find-resource c: hare-a c: 10)
	(up-find-resource c: hare-b c: 10)
	(up-get-search-state local-total)
)
...
(defrule
	(civ-selected 42)
	(or(game-time < 200)
	(or(cc-players-unit-type-count 0 forage-bush-class < 8)
	(or(map-type scandanavia)
	(unit-type-count-total villager < 5))))
=>
	(up-jump-rule 28)
...
(defrule
	...
	(cc-players-unit-type-count 0 wild-chicken-a <= 0)
	(cc-players-unit-type-count 0 wild-chicken-b <= 0)
	(cc-players-unit-type-count 0 wild-chicken-c <= 0)
	(cc-players-unit-type-count 0 hare-a <= 0)
	(cc-players-unit-type-count 0 hare-b <= 0)
=>
	(up-jump-rule 2))
(defrule
(or	(building-type-count-total wood-building <= 0)
...
=>
	...
	(nand(building-type-count-total monastery < 1)
	(building-type-count-total siege-workshop < 1))
	(nand(building-type-count-total university < 1)
	(building-type-count-total siege-workshop < 1))
	(building-type-count-total castle < 1)
	(building-type-count-total farm > 10)
=>
	(set-goal farm-goal 0) ;disable farm building to get imp buildings up
)
(defrule
...
(defrule
	...
	(building-type-count-total town-center > 3))
	(building-type-count-total town-center > 1)
	(or(building-type-count-total fortified-church < 3)
	(building-type-count-total castle > 0))
	(building-type-count-total fortified-church < 8)
	(building-type-count-total monastery-class < 8);jic
	(can-build fortified-church)
	(or(civ-selected armenians)
	(civ-selected georgians))
=>
	(set-goal increase-ts fortified-church)
	(enable-timer increase-ts-timer 7)
)

(defrule
	(civ-selected georgians)
	(building-type-count monastery-class < 1)
	(building-type-count-total fortified-church < 1)
	(wood-amount > 210)
	(can-build fortified-church)
	(current-age == castle-age)
=>
...
=>
	...
	(up-modify-sn sn-focus-player-number g:= my-flank2) ;sometimes my-flank2 is actually the flank!
	(up-find-remote c: town-center c: 1)
...
;intention is that the same villager builds monastery
(defrule
	(goal strategy krush)
	(goal siegevar yes)
	(can-build monastery)
...
(defrule
	...
	(building-type-count siege-workshop > 0)
;	(timer-triggered threesec)
	(up-can-build-line 0 point-x c: monastery)
=>
	(up-build-line point-x point-x c: monastery)
	(up-jump-rule 2)
)
...
(defrule
	...
	(or(warboat-count > 20)
	(or(unit-type-count-total fire-galley-line > 5)
	(players-unit-type-count target-player galley-line > 1)))));clinker construction matters in this lineup
	(can-build university)
	(building-type-count-total university < 1)
	(building-type-count-total town-center > 0)
=>
	(set-goal increase-ts university)
	(set-goal increase-ts-timer 7)
)
...
(defrule
	...
	(players-building-type-count market every-ally < 1)
	(or(game-time > 2400)
	(building-type-count-total town-center > 3))
...
=>
	...
	(up-modify-goal temporary-goal7 s:= sn-focus-player-number)
	(set-strategic-number sn-focus-player-number 0)
	(set-goal temporary-goal 24687654)
;	(fe-break-point 1 c:== 1 -1)
)

(defrule
	(goal temporary-goal 24687654)
=>
	(set-goal point-x 1)
	(set-goal point-y 1)
	(up-get-point position-map-size point2-x)
	(up-get-point position-map-size point3-x)
	(up-get-point position-map-size point4-x)
	(set-goal point3-x 1)
	(set-goal point4-y 1)
	(up-get-point-distance position-self-x point-x temporary-goal2)
	(up-get-point-distance position-self-x point2-x temporary-goal3)
	(up-get-point-distance position-self-x point3-x temporary-goal4)
	(up-get-point-distance position-self-x point4-x temporary-goal5)
)
;Use sorting network, n=4
(defrule
	(goal temporary-goal 24687654)
	(up-compare-goal temporary-goal2 > temporary-goal3)
=>
	(up-modify-goal temporary-goal6 g:= temporary-goal3)
	(up-modify-goal temporary-goal3 g:= temporary-goal2)
	(up-modify-goal temporary-goal2 g:= temporary-goal6);so temporary-goal2/point-x now contains minimum of point-x/point2-x dist
	(up-copy-point temporary-point-x point-x)
	(up-copy-point point-x point2-x)
	(up-copy-point point2-x temporary-point-x)
)
...
=>
	...
	(up-modify-goal temporary-goal4 g:= temporary-goal6);so temporary-goal4/point3-x now contains minimum of point3-x/point4-x distance
	(up-copy-point temporary-point-x point3-x)
	(up-copy-point point3-x point4-x)
	(up-copy-point point4-x temporary-point-x)
)

(defrule
	(goal temporary-goal 24687654)
	(up-compare-goal temporary-goal2 > temporary-goal4)
=>
	(up-modify-goal temporary-goal6 g:= temporary-goal4)
	(up-modify-goal temporary-goal4 g:= temporary-goal2)
	(up-modify-goal temporary-goal2 g:= temporary-goal6);so temporary-goal2/point-x contains lowest value
	(up-copy-point temporary-point-x point3-x)
	(up-copy-point point3-x point-x)
	(up-copy-point point-x temporary-point-x)
)
...
(defrule
	(goal temporary-goal 24687654)
	(up-compare-goal temporary-goal3 > temporary-goal5)
=>
	(up-modify-goal temporary-goal6 g:= temporary-goal5)
	(up-modify-goal temporary-goal5 g:= temporary-goal3)
	(up-modify-goal temporary-goal3 g:= temporary-goal6)
	(up-copy-point temporary-point-x point4-x)
	(up-copy-point point4-x point2-x)
	(up-copy-point point2-x temporary-point-x)
)

(defrule
	(goal temporary-goal 24687654)
	(up-compare-goal temporary-goal3 > temporary-goal4)
=>
	(up-modify-goal temporary-goal6 g:= temporary-goal4)
	(up-modify-goal temporary-goal4 g:= temporary-goal3)
	(up-modify-goal temporary-goal3 g:= temporary-goal6)
...
;At the end of this, if we have implemented this correctly point-x and point2-x should be the two closest corners to TC
...
=>
	...
	(up-set-target-object search-remote c: 0)
	(up-get-point position-object point3-x)
	(up-get-point-distance point-x point3-x temporary-goal2)
	(up-get-point-distance point2-x point3-x temporary-goal3)
	(set-goal temporary-goal9 25)
)

(defrule
	(up-compare-goal temporary-goal3 >= temporary-goal2)
	(goal temporary-goal 24687654)
=>
	(up-copy-point point-x point2-x);The result of this is that the two candidate points, the one furthest from the market is taken
)
...
(defrule
	...
	(goal increase-ts 0)
(or	(strategic-number sn-current-age >= imperial)
	(unit-type-count-total merchant-ship >= 6)); 8
	(building-type-count-total town-center >= 1)
(or	(players-building-type-count any-ally dock >= 1)
	(players-building-type-count any-ally port >= 1))
	(goal tradecarts no)
...
(or	(and	(building-type-count-total market >= 1)
	...
	(building-type-count-total dock < {{BUILDINGS_DOCK_052}})
	(can-build dock)
=>
	(build dock))
...
(or	(and	(building-type-count-total market >= 1)
		(building-type-count-total blacksmith >= 1))
	(strategic-number sn-current-age >= fcastlea))
	(building-type-count-total port < {{BUILDINGS_PORT_053}})
	(can-build port)
=>
	(build port))
...
(or	(and	(building-type-count-total market >= 1)
		(building-type-count-total blacksmith >= 1))
	(strategic-number sn-current-age >= fcastlea))
	(building-type-count-total shipyard < {{BUILDINGS_SHIPYARD_054}})
	(can-build shipyard)
=>
	(build shipyard))
...
(or	(goal map water)
	(goal enemy-boats yes))
	(building-type-count-total dock < {{BUILDINGS_DOCK_055}})
	(can-build dock)
=>
	(build dock))
...
(or	(goal map water)
	(goal enemy-boats yes))
	(building-type-count-total port < {{BUILDINGS_PORT_056}})
	(can-build port)
=>
	(build port))
...
(or	(goal map water)
	(goal enemy-boats yes))
	(building-type-count-total shipyard < {{BUILDINGS_SHIPYARD_057}})
	(can-build shipyard)
=>
	(build shipyard))
...
(or	(strategic-number sn-current-age >= dfeudal)
	...
	(building-type-count-total dock < {{BUILDINGS_DOCK_058}})
(or	(building-type-count-total dock < {{BUILDINGS_DOCK_059}})
(or	(building-type-count-total market >= 1)
	(up-compare-goal excessWood >= 325)))
	(can-build dock)
=>
...
(or	(strategic-number sn-current-age >= dfeudal)
	(up-compare-goal gr-var >= 2))
	(building-type-count-total shipyard < {{BUILDINGS_SHIPYARD_060}})
(or	(building-type-count-total shipyard < {{BUILDINGS_SHIPYARD_061}})
(or	(building-type-count-total market >= 1)
	(up-compare-goal excessWood >= 325)))
	(can-build shipyard)
=>
...
(defrule
	...
	(up-compare-goal excessWood < 4200)
	(building-type-count-total shipyard >= 3)
	(up-compare-goal trainmonoreme != yes)
	(up-compare-goal trainarrowship != yes)
	(up-compare-goal trainincendiary != yes)
	(up-compare-goal traincatapultship != yes)
	(up-compare-goal trainocteres != yes)
=>
	(up-jump-rule 7))
...
(or	(goal inseln yes)
	(goal enemy-boats yes)))
	(building-type-count-total dock < {{BUILDINGS_DOCK_062}})
	(can-build dock)
=>
	(build dock))
...
(or	(goal inseln yes)
	(goal enemy-boats yes)))
	(building-type-count-total shipyard < {{BUILDINGS_SHIPYARD_063}})
	(can-build shipyard)
=>
	(build shipyard))
...
(or	(building-type-count-total town-center <= 0)
(or	(and (building-type-count-total dock <= 0)
	     (building-type-count-total port <= 0))
...
=>
	(up-full-reset-search)
	(up-find-local c: shipyard c: 24)
	(up-filter-status c: status-pending c: list-active)
	(up-find-status-local c: shipyard c: 24)
	(up-get-point position-center point-x)
	(up-get-search-state local-total))
...
(defrule
	...
	(civ-selected gothic))
	(building-type-count-total watch-tower-building < 10)
...
(defrule
	...
	(up-can-build-line 0 point-x c: watch-tower)
=>
	(up-build-line point-x point-x c: watch-tower-building)
)

(defrule
	(goal group-micro yes)
	(up-point-distance ranged-group1-x enemy-x < 16)
	(can-build watch-tower-building)
...
(defrule
	...
	(up-compare-goal temporary-goal > 0)
	(up-compare-goal temporary-goal2 < 1)
	(up-point-distance ranged-group1-x enemy-x > 8)
=>
	(set-goal temporary-goal4 24689)
	(up-bound-point point-x ranged-group1-x)
	(up-lerp-tiles point-x enemy-x c: -1)
	(up-lerp-tiles point-x position-self-x c: 1)
)


(defrule
	(goal temporary-goal4 24689)
	(up-can-build-line 0 point-x c: watch-tower-building)
=>
	(up-build-line point-x point-x c: watch-tower-building)
...
(defrule
	...
	(can-build watch-tower-building)
=>
	(build-forward watch-tower-building)
)
...
(defrule
	...
	(timer-triggered threesec)
	(current-age < imperial-age)
	(up-point-distance point-x position-self-x > 35)
	(up-point-distance point-x enemy-x < 30)
	(wood-amount > 25)
=>
	(up-bound-point point2-x point-x)
	(up-bound-point point3-x point-x)
	(up-bound-point point4-x point-x)
	(up-modify-goal point2-x c:+ 1)
	(up-modify-goal point2-y c:+ 1)
	(up-modify-goal point3-x c:- 1)
	(up-modify-goal point3-y c:+ 1)
	(up-modify-goal point4-x c:- 1)
	(up-modify-goal point4-y c:- 1)
	(up-modify-goal point-x c:+ 1)
	(up-modify-goal point-y c:- 1)
	(up-build-line point-x point4-x c: palisade-wall)
	(up-build-line point2-x point3-x c: palisade-wall)
	(up-build-line point3-x point4-x c: palisade-wall)
...
=>
	...
	(up-get-point position-object temporary-point-x)
	(up-get-point position-target point-x)
	(up-lerp-tiles temporary-point-x point-x c: 3)
	(set-goal temporary-goal3 8)
)
...
=>
	(up-build-line temporary-point-x temporary-point-x c: watch-tower)
	(up-assign-builders c: watch-tower c: 3)
	(up-jump-rule 2)
)
...
(defrule
	...
	(building-type-count-total watch-tower < {{BUILDINGS_WATCH_TOWER_068}})
	(can-build watch-tower)
	(building-type-count-total town-center > 0)
=>
	(build watch-tower)
...
;	(up-jump-rule 5))
(defrule
	(nand(up-compare-const diff-fp != 1)
...
=>
	...
	(up-modify-goal temporary-goal11 c:- 1);sanity check
	(up-full-reset-search)
	(up-jump-rule -3))
(defrule
	(goal temporary-goal7 4385)
...
(or	(up-point-explored object-point-x == explored-no)
	...
	(up-compare-goal object-point-x >= 0);can't add sanity check here since the intent of these rules seems to be to compare a bound
=>;and unbound point
...
;	(chat-local-to-self "Deleting walls.")
	;(up-target-point 0 action-delete -1 -1)); end jump - disabled for now (eventually want to replace with building additional gates in starting walls)
)
...
(not	(up-point-contains point-x c: stone-wall-line))
	...
	(building-type-count-total palisade-gate1 < 1)
	(building-type-count-total palisade-gate2 < 1)
	(building-type-count-total palisade-gate3 < 1)
	(building-type-count-total palisade-gate4 < 1)
=>
	(up-full-reset-search)
	(up-find-local c: wall-class c: 40)
	(up-set-target-point center-x)
	(up-clean-search search-local -1 search-order-asc)
	(up-clean-search search-local object-data-distance search-order-asc)
	(up-set-target-object search-local c: 0)
	(up-get-point position-object point4-x)
	(up-set-target-object search-local c: 1);next closest wall piece
	(up-get-point position-object point3-x)
	(up-modify-goal point3-x g:- point4-x);Observe whether x point changes to conclude whether we need a horizontal or vertical gate
	;(chat-to-all "Potential pathing problem")
...
(not	(up-point-contains point-x c: stone-wall-line))
	...
	(building-type-count-total palisade-gate4 < 1)
	(up-compare-goal point3-x < 0)
	(up-can-build-line 0 point4-x c: palisade-gate1)
=>
	(up-build-line 0 point4-x c: palisade-gate1)
	;(chat-to-all "Build gate 1")
	(up-jump-rule 2)
)
...
(not	(up-point-contains point-x c: stone-wall-line))
	...
	(building-type-count-total palisade-gate3 < 1)
	(building-type-count-total palisade-gate4 < 1)
	(building-type-count-total palisade-gate-foundation2 < 1)
	(up-compare-goal point3-x >= 0)
	(up-can-build-line 0 point4-x c: palisade-gate-foundation2)
=>
	(up-build-line point4-x point4-x c: palisade-gate-foundation2)
	;(chat-to-all "build gate 2")
	(up-jump-rule 1)
)
...
(not	(up-point-contains point-x c: stone-wall-line))
	(up-path-distance point-x 0 == 65535)
	(up-pending-objects c: palisade-gate1 < 1)
	(up-pending-objects c: palisade-gate4 < 1)
	(wood-amount > 40)
=>
...
#load-if-not-defined MAPUCHE-CIV;don't want to delete camps that could be farms
...
(defrule
	...
	(building-type-count-total fortified-church < 10)
	(building-type-count-total monastery-class < 10)
=>
	(set-goal increase-ts fortified-church)
)

(defrule
	(goal increase-ts fortified-church)
	(or(civ-selected armenians)
	(civ-selected georgians))
	(building-type-count-total castle < 1)
	(building-type-count-total fortified-church > 2)
=>
	(set-goal increase-ts 0)
)
(defrule
	(or(goal increase-ts fortified-church)
	(goal increase-ts monastery))
	(or(building-type-count-total fortified-church > 8)
	(building-type-count-total monastery-class > 8))
=>
	(set-goal increase-ts 0)
)

;Delay military buildings on non-Dark Age low resources start

#load-if-defined RANDOM-MAP 
...
=>
	(set-goal increase-ts 0)
	;(chat-to-player my-player-number "Delay buildings")
)
...
(defrule
	...
	(building-type-count-total monastery < 1)
	(building-type-count-total barracks < 1)
	(or(up-compare-goal increase-ts == barracks)
	(up-compare-goal increase-ts == monastery))
	(strategic-number cavalry < 3)
=>
	(set-goal increase-ts 0)
	;(chat-to-player my-player-number "Delay barracks/monastery in favour of archery range/stable")
)
;Get archery range if camps set up and AI doesn't build another military building
(defrule
	(wood-amount > 200);give the AI the chance to try and build something else
	(can-build archery-range)
	(current-age == feudal-age)
	(building-type-count-total archery-range < 1)
	(building-type-count-total wood-building > 0)
...
#end-if
#end-if
;Test of possible new building system
#load-if-not-defined ARENA-MAP
...
(defrule
	...
	(can-build fortified-church)
	(wood-amount > 200)
	(building-type-count-total monastery-class < 12)
	(or(building-type-count-total monastery-class < 4)
	(civ-selected georgians))
=>
	(up-full-reset-search)
	(up-find-local c: town-center c: 10)
...
=>
	(up-get-point position-object point-x)
	(up-lerp-tiles point-x position-self-x c: -7)
	(set-goal temporary-goal 246890)
	(set-goal temporary-goal3 12)
;	(up-send-flare point-x)
)

(defrule
	(goal temporary-goal 246890)
	(or(up-can-build-line 0 point-x c: fortified-church)
	(up-can-build-line 0 point-x c: monastery))
	(building-type-count-total monastery-class < 12)
	(or(building-type-count-total monastery-class < 4)
	(civ-selected georgians))
=>
	(up-build-line point-x point-x c: fortified-church)
	(up-build-line point-x point-x c: monastery)
	(set-goal increase-ts 2)
	(up-jump-rule 4)
)
...
;	(chat-local-to-self "Attempting to place monastery.")
	...
	(up-build place-control 0 c: fortified-church)
	(set-goal increase-ts 2);	(set-goal increase-ts 0)
	(up-jump-rule 1))
(defrule
	(goal increase-ts fortified-church)
...
(or	(and	(up-compare-goal excessWood < sw-cost)
		(or	(goal increase-ts university)
			(goal increase-ts siege-workshop)))
(or	(and	(up-compare-goal excessWood < dock-cost);dock and shipyard costs are the same, no action required
		(goal increase-ts dock));not sure where increase-ts can possibly be set to dock
...
(defrule
	...
	(cc-players-building-type-count 0 market > 0) ;regular players-unit-type-count doesn't work in this situation, michi is explored anyway
	(can-build market)
	(building-type-count-total market < 2) ;presumably we already have a market from going up to castle
	=>
	(up-modify-goal temporary-goal7 s:= sn-focus-player-number)
	(set-strategic-number sn-focus-player-number 0)
	(up-find-remote c: market c: 1) ;previously weird-gaia-market
	(up-set-target-object search-remote c: 0)
	(up-get-point position-object temporary-point-x)
...
(defrule
	(building-type-count-total town-center > 2)
	(players-building-type-count every-ally market < 1)
	(cc-players-building-type-count 0 market > 0);previously weird-gaia-market
	(can-build market)
	(building-type-count-total market < 2) 
...
(defrule
	(players-building-type-count market any-ally > 6) ;this is to prevent ally markets blocking each other
...
;putting this at the bottom to make sure it isn't jumped
...
#end-if
;#load-if-defined KAWASAN-MAP doesn't seem to be an actual load
(defrule
	(nor(map-type kawasan)
	(map-type four-lakes))
=>
	(up-jump-rule 8)
)
...
(defrule
	(true)
=>
	(set-strategic-number sn-minimum-water-body-size-for-dock 0)
)
...
(defrule
	(or(up-find-resource c: 69 c: 1);nice
	(up-find-resource c: 1141 c: 1));box turtles
	(wood-amount > 150);(shore fish id)
	(building-type-count-total dock < 1)
	(building-type-count-total port < 1)
	(or(wood-amount > 250)
	(building-type-count-total wood-building > 0))
=>
	(up-full-reset-search)
	(up-filter-status c: status-gather c: list-active)
	(up-find-resource c: 69 c: 1)
	(up-find-resource c: 1141 c: 1)
	(up-set-target-object search-remote c: 0)
	(up-get-point position-object point-x)
	(set-goal temporary-goal3 15)
;	(chat-to-player my-player-number "Setting up dock/port placement")
)

(defrule
	(goal paphosciv no)
	(up-can-build-line 0 point-x c: dock)
	(wood-amount > 150)
...
(defrule
	(goal paphosciv yes)
	(up-can-build-line 0 point-x c: port)
	(wood-amount > 125)
	(building-type-count-total port < 1)
	(or(wood-amount > 250)
	(building-type-count-total wood-building > 0))
...
=>
	...
	(up-modify-goal point-x g:+ temporary-goal)
	(up-modify-goal point-y g:+ temporary-goal2)
	(up-modify-goal point-x c:- 3)
	(up-modify-goal point-y c:- 3)
	(up-modify-goal temporary-goal3 c:- 1)
;	(up-send-flare point-x)
	(up-jump-rule -3)
)
...
(defrule
	...
	(wood-amount > 600)
	(building-type-count-total fish-trap < 5)
	(building-type-count-total dock > 0)
	(or(goal attacking yes)
	(not(town-under-attack)))
	(up-pending-objects c: fish-trap < 1)
=>
	(up-full-reset-search)
...
; 	(not(town-under-attack)))
; 	(up-pending-objects c: fish-trap < 1)
; 	(up-can-build-line 0 point2-x c: fish-trap)
; =>
; 	(up-build-line point2-x point2-x c: fish-trap)
; 	(up-jump-rule 1)
; 	)
...
; (defrule
; 	(up-pending-objects c: fish-trap > 0)
; =>
; 	(up-full-reset-search)
; 	(up-filter-status c: status-pending c: list-active)
; 	(up-find-local c: fish-trap c: 1)
; 	(up-set-target-object search-local c: 0)
; 	(up-get-point position-object point3-x)
; 	(up-set-target-point point3-x)
; 	(up-full-reset-search)
; 	(up-find-local c: fishing-ship c: 8)
; 	(up-clean-search search-local -1 search-order-asc)
; 	(up-clean-search search-local object-data-distance search-order-asc)
; 	(up-remove-objects search-local -1 > 0)
; 	(up-target-point point3-x action-default -1 -1)
; )
...
=>
    ...
    (up-get-search-state temporary-goal)
    (up-modify-goal temporary-goal5 g:mod temporary-goal)
...
=>
    (up-full-reset-search)
    ;(up-chat-data-to-player my-player-number "Attempting to build caravanserai at %d" g: point-x)
...
(defrule
    ...
    (wood-amount > 400)
    (up-pending-objects c: caravanserai < 1)
    (up-can-build-line 0 temporary-point-x c: caravanserai)
=>
    (up-build-line temporary-point-x temporary-point-x c: caravanserai)
    (up-jump-rule 2)
)
...
=>
    (up-modify-goal temporary-goal3 c:- 1)
    (up-lerp-tiles temporary-point-x point-x c: 1)
    (up-jump-rule -2)
)
...
(defrule
    (can-build caravanserai)
    (unit-type-count-total trade-cart > 20)
    (building-type-count-total caravanserai < {{BUILDINGS_CARAVANSERAI_077}})
    (wood-amount > 400)
    (up-pending-objects c: caravanserai < 1)
=>
    (build caravanserai)
...
;Build additional gates in walls for trade (instead of delete)

(defrule
    (or(building-type-count-total gate > 7);was gate class
    (or(building-type-count-total castle < 2)
    (or(players-building-type-count every-ally town-center < 1)
    (or(stone-amount < 200)
    (or(civ-selected cumans)
...
(defrule
    ...
    (building-type-count-total wall-class > 30)
...
;    (up-send-flare point-x)
    ...
    (up-lerp-percent point-x point3-x c: 70)
    (up-set-target-point point-x)
    (up-filter-distance c: 8 c: 30)
;    (up-send-flare point-x)
)
...
=>
 ...
 ;   (up-send-flare point-x)
    ...
    (set-goal temporary-goal2 393969)
    (up-modify-sn sn-focus-player-number g:= temporary-goal7)
)
...
(defrule
    ...
    (building-type-count-total wall-class > 30)
    (up-find-local c: wall-class c: 40)
    (goal temporary-goal2 393969)
=>
    (up-clean-search search-local -1 search-order-asc)
    (up-clean-search search-local -1 object-data-distance)
    (up-set-target-object search-local c: 0)
    (up-remove-objects search-local -1 > 1)
    (up-get-point position-object point-x)
    ;(up-build-line point-x point-x c: gate-descending)
    (up-set-target-object search-local c: 1)
    (up-get-point position-object point2-x)
    (up-modify-goal point2-x g:- point-x)
    (up-modify-goal point2-y g:- point-y)
    (set-goal temporary-goal2 393970)
;    (up-target-point point-x action-delete -1 -1)
    ; (up-send-flare point-x)
    ; (set-strategic-number 490 10)
    ; (up-full-reset-search)
    ; (up-filter-distance c: -1 c: 2)
...
(defrule
    (goal temporary-goal2 393970)
    (up-compare-goal point2-x == 0)
    (up-compare-goal point2-y != 0)
	(up-can-build-line 0 point-x c: gate-descending)
=>
    (up-build-line point-x point-x c: gate-descending)
;    (chat-to-player my-player-number "Y point moved, build descending gate")
)
...
(defrule
    ...
    (up-compare-goal point2-x != 0)
    (up-compare-goal point2-y == 0)
	(up-can-build-line 0 point-x c: gate-ascending)
=>
    (up-build-line point-x point-x c: gate-ascending)
 ;   (chat-to-player my-player-number "X point moved, build ascending gate")
)    
#load-if-not-defined WONDER-RACE
#load-if-not-defined DIFFICULTY-EASIEST
#load-if-not-defined DIFFICULTY-EASY
(defrule	
	(nand(victory-condition standard)
	(current-age == imperial-age))
	(can-build-with-escrow castle)
	(stone-amount > 750)
	(building-type-count-total castle < {{BUILDINGS_CASTLE_078}})
=>
...
=>
    ...
    (up-get-fact building-type-count-total mule-cart temporary-goal2)
;    (up-modify-goal temporary-goal2 c:- 1)
    (up-modify-goal temporary-goal2 c:* 300)
    (up-modify-goal temporary-goal g:- temporary-goal2)
)
...
(defrule
    ...
    (unit-type-count-total villager > 10)
    (building-type-count-total town-center > 0)
    (building-type-count-total mule-cart < {{BUILDINGS_MULE_CART_079}})
    (unit-type-count-total villager-gold > 0)
=>
    (build mule-cart)
)
...
(defrule
    ...
    (up-compare-goal temporary-goal > 0)
    (unit-type-count villager > 6)
    (unit-type-count-total mule-cart < 9)
=>
    (build mule-cart); test SNs
)

(defrule
	(up-compare-const diff-fp == 1);max dificultly
	;(timer-triggered threesec)
	(game-time < 900)
	(players-building-type-count target-player watch-tower < 3);Don't try to build counter tower against 3+ towers
	;(players-building-type-count target-player watch-tower > 0)
=>
	(up-full-reset-search)
	;(fe-break-point 1 c:== 1 -1)
	(up-modify-goal temporary-goal7 s:= sn-focus-player-number);save focus player for future use
	(up-modify-sn sn-focus-player-number s:= sn-target-player-number);set focus player number to target player (1)
	(up-set-target-point position-self-x);search around the AI's base (5-22 tiles)
	(up-filter-distance c: 5 c: 22)
	(up-find-remote c: watch-tower c: 2);Find enemy watch towers
	(up-get-search-state local-total);Record number found into (remote-total)
	(set-goal temporary-goal6 2435);Temp variable just to avoid repeating code
	(up-modify-sn sn-focus-player-number g:= temporary-goal7);Restore focus player
	)
;Set up the point where we initially attempt to build the tower
(defrule
	(goal temporary-goal6 2435);Only fires if previous rule did
	(up-compare-goal remote-total > 0)
	(up-set-target-object search-remote c: 0)
=>

	(up-get-point position-object point-x);Get the point of the offending tower (target object)
	(up-get-point position-object point2-x)
	(up-lerp-tiles point-x position-self-x c: 6);Try 6 tiles closer to the TC than the tower and store it as point-x
	(up-get-object-data object-data-hitpoints temporary-goal);Check the HP of the tower
	(set-goal temporary-goal6 2436)
	(set-goal temporary-goal3 6)
)
;Build the tower
(defrule
	(goal temporary-goal6 2436)
	(up-can-build-line 0 point-x c: watch-tower-building);Can we build a tower at point-x?
	(building-type-count-total watch-tower < 2)
	;(up-point-contains point-x != watch-tower-building)
=>
	(up-build-line point-x point-x c: watch-tower-building);If so, build at point-x
	(up-assign-builders c: watch-tower-building c: 5);Assign 5 villagers to build the tower so it goes up first
	(up-jump-rule 1)
)
;Adjust the attempted point (if necessary) if we can't build the tower
(defrule
	(goal temporary-goal6 2436);This rule only fires if the previous one did not,
	;(up-can-build-line 0 point-x c: watch-tower-building)
	(building-type-count-total watch-tower < 2)
	;(up-point-contains point-x != watch-tower-building)
	(up-compare-goal temporary-goal3 > 0);Try up to 5 times to adjust the point
	(can-build watch-tower-building)
=>
	(generate-random-number 3)
	(up-get-fact random-number 0 temporary-goal2)
	(up-modify-goal temporary-goal2 c:- 2);Try a random deviation (moving 1 tile perpendicular in either direction, or 0 tiles)
	(up-cross-tiles point-x point2-x g: temporary-goal2)
	(up-modify-goal temporary-goal3 c:- 1)
	(up-jump-rule -2);Go back and try again
)
;Send more villagers to the tower if enemy has army or the enemy tower is almost complete
(defrule
	(goal temporary-goal6 2436)
	(or(up-compare-goal temporary-goal > 600);tower is built or almost built, send more vills
	(players-unit-type-count target-player militiaman-line > 2))
=>
	(up-assign-builders c: watch-tower-building c: 10)
)

;When the tower is up see whether we need to garrison it
(defrule
	(strategic-number counter-tower > 0)
=>
	(up-full-reset-search)
	(up-find-local c: watch-tower c: 5);This will only find completed watch towers
	(up-remove-objects search-local object-data-hitpoints < 300)
	(up-remove-objects search-local object-data-garrison-count > 4)
	(up-get-search-state local-total)
	(set-goal temporary-goal3 5)
)
;Find potential towers to garrison
(defrule
	(strategic-number counter-tower > 0)
	(up-compare-goal local-total > 0)
	(up-set-target-object search-local c: 0);This will only fire if a watch tower was found in the previous rule
=>
	...
	(up-find-remote c: watch-tower c: 1)
	(set-goal temporary-goal4 3214)
	(up-modify-sn sn-focus-player-number g:= temporary-goal7)
)
;Garrison the tower
(defrule
	(goal temporary-goal4 3214)
	(strategic-number counter-tower > 0)
	(up-compare-goal local-total > 0)
=>
	(up-full-reset-search)
...
;Loop through all towers if there are multiple
(defrule
	(strategic-number counter-tower > 0)
	(up-compare-goal local-total > 0)
	(up-compare-goal temporary-goal3 > 0)
...
;Anti-fortified church defense


(defrule
	(or(players-civ any-enemy georgians)
	(players-civ any-enemy armenians))
	(players-building-type-count any-enemy monastery > 0)
	(game-time < 1800)
	;(strategic-number sn-ten-turns == 4)
...
=>
	...
	(up-modify-goal temporary-goal2 c:+ 4)
	(up-modify-goal temporary-goal2 c:min 18)
	(up-modify-goal temporary-goal2 c:min 32)
	(up-modify-goal temporary-goal7 s:= sn-focus-player-number)
	(up-modify-sn sn-focus-player-number s:= sn-target-player-number)
	(up-filter-distance c: -1 g: temporary-goal2)
	(up-find-remote c: monastery c: 5)

	(set-goal temporary-goal 4891)
)
;Determine if there are enemy units around it
(defrule
	(goal temporary-goal 4891)
	(up-set-target-object search-remote c: 0)
=>
	;(chat-to-all "Debug: FC detected")
	(up-get-object-data object-data-id temporary-goal8)
	(up-get-point position-object point-x)
	(up-full-reset-search)
	(up-set-target-point point-x)
	(up-filter-distance c: -1 c: 7)
	...
	(up-find-remote c: all-units-class c: 5)
	(up-get-search-state local-total)
	(set-goal temporary-goal 4892)
)
;If only 1 non-knight enemy unit near, just attack it
(defrule
	(goal temporary-goal 4892)
	(up-compare-goal remote-total < 2)
	(players-unit-type-count target-player knight-line < 1);1 knight is fatal
=>
	(up-full-reset-search)
	(up-set-target-by-id g: temporary-goal8)
	(up-add-object-by-id search-remote g: temporary-goal8)
	(up-filter-distance c: -1 c: 15)
	(up-find-local c: villager-class c: 15)
	(up-target-objects 0 action-default -1 -1)
	;(chat-to-all "Debug: Attack the FC")
	(up-jump-rule 1)
)
;Else, evacuate villagers if garrisoned
(defrule
	(goal temporary-goal 4892)
	(up-set-target-by-id g: temporary-goal8)
...
=>
	...
	(up-filter-distance c: -1 c: 7)
	(up-find-local c: villager-class c: 15)
	(up-remove-objects search-local object-data-order == orderid-enter);If villagers are garrisoning that's already appropiate
	(up-remove-objects search-local object-data-order == orderid-build);Probably best to let the AI engine cancel a building rather than potentially wait infinitely for it
	(up-lerp-percent point-x position-self-x c: 300);Mirror through the TC to find somewhere suitable
	(up-bound-point point-x point-x)
	(up-set-target-point point-x)
	(up-filter-distance c: -1 c: 15)
	(up-find-resource c: wood c: 1)
	;(chat-to-all "Debug: Retreat")
	(up-target-objects 0 action-gather -1 -1)
)

;Reset settlement placement back to -1 perodically

(defrule
	(goal lock-settlement-placement yes)
=>
