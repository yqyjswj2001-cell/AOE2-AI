...
=>
	...
	(chat-local-to-self "Debug: Moving scout to TC to prepare to guard dock builder")
)
...
=>
	(up-full-reset-search)
	(up-filter-status c: status-pending c: list-active)
	(up-find-status-local c: port c: 1)
	(up-set-target-object search-local c: 0)
	(up-get-point position-object point-x)
	(up-set-target-point point-x)
)
...
(defrule
	(up-compare-const diff-fp == 1)
	(unit-type-count scout-unit > 0)
(or	(up-pending-objects c: dock >= 1)
	(up-pending-objects c: port >= 1))
	(not(research-completed ri-loom))
	(timer-triggered threesec)
...
;	(players-building-count target-player > 0)
	(up-compare-goal drushtarget == 0)
(or	(strategic-number sn-minimum-attack-group-size != {{ORB_ATTACK_GROUP_001}})
	(strategic-number sn-maximum-attack-group-size != {{ORB_ATTACK_GROUP_002}}))
=>
;	(chat-local-to-self "Attacking with groups.")
	(set-strategic-number sn-number-attack-groups {{ORB_ATTACK_GROUP_003}})
	(set-strategic-number sn-percent-attack-soldiers {{ORB_ATTACK_GROUP_004}})
	(set-strategic-number sn-minimum-attack-group-size {{ORB_ATTACK_GROUP_005}})
	(set-strategic-number sn-maximum-attack-group-size {{ORB_ATTACK_GROUP_006}}))
(defrule
	(players-building-count target-player > 0)
	(up-compare-goal drushtarget != 0)
	(strategic-number sn-minimum-attack-group-size == {{ORB_ATTACK_GROUP_007}})
	(strategic-number sn-maximum-attack-group-size == {{ORB_ATTACK_GROUP_008}})
=>
...
(or	(up-compare-goal temporary-goal2 g:<= temporary-goal); militia closer than waypoint
	(and	(strategic-number sn-minimum-attack-group-size == {{ORB_ATTACK_GROUP_009}})
		(strategic-number sn-maximum-attack-group-size == {{ORB_ATTACK_GROUP_010}})))
=>
	(up-set-target-point position-self-x)
...
(defrule
	...
	(up-compare-goal war-chariot-set <= 0)
=>
;	(chat-to-all " test4 ")
	(up-jump-rule 18))
(defrule
...
=>
	...
	(up-find-local c: war-chariot g: temporary-goal10)
	(up-find-local c: elite-war-chariot g: temporary-goal10)
...
=>
 ...
 ;   (up-find-local c: 128 c: 40);128 = empty trade cart
	(up-filter-exclude -1 actionid-trade -1 -1)
    (up-find-local c: trade-cart c: 40)
...
(defrule
	...
	(cc-players-building-type-count 0 dock > 0);not a cheat, a human player would know this upon selecting the map
...
(defrule
	...
	(current-age >= feudal-age)
	(unit-type-count-total trade-cog > 0)
	(up-find-remote c: dock c: 40) 
	(cc-players-building-type-count 0 dock > 0)
	(players-building-type-count every-ally dock < 1)
=>
    (up-remove-objects search-remote object-data-language-id != 5144) ; dock language id.
    (up-clean-search search-local -1 search-order-asc)
 ;   (up-find-local c: 128 c: 40);128 = empty trade cart
	;(up-filter-exclude -1 actionid-trade -1 -1)
    (up-find-local c: trade-cog c: 40)
    (up-find-local c: 17 c: 40)
    (up-remove-objects search-local object-data-carry > 0)
    (up-set-target-object search-remote c: 0)
	 (up-target-objects 0 action-default -1 -1)
    (up-get-point position-object point-x) 
...
=>
	...
	(up-get-point position-object point-x)
	(up-modify-goal temporary-goal3 c:- 1)
	(chat-local-to-self "adjust dock target")
;	(fe-break-point 1 c:== 1 -1)
	(up-jump-rule -1)
)
...
=>
	...
	(up-remove-objects search-local object-data-hitpoints > 100)
	(up-get-search-state local-total)
)
...
=>
	...
	(up-find-local c: villager-class c: 1)
	(up-add-object-by-id search-remote g: temporary-goal2)
	(up-target-objects 0 action-default -1 -1)
)

;Backup for stuck scout
...
=>
	...
	(up-modify-goal point-x c:+ 15)
	(up-modify-goal point-y c:+ 15)
	(up-target-point point-x action-default -1 -1)
	(disable-self)
)

#load-if-defined KHMER-CIV
;Simple villager garrison code
...
=>
	(up-full-reset-search)
	(up-find-local c: house c: 40)
	(up-target-objects 0 action-unload -1 -1)
)
...
=>
 ;   (fe-break-point 1 c:== 1 -1)
    (up-full-reset-search)
    (up-set-target-point position-self-x)
    (up-filter-distance c: 9 c: 50)
    (up-find-resource c: wood c: 40)
    (up-clean-search search-remote -1 search-order-asc)
    (up-clean-search search-remote object-data-distance search-order-asc)
    (set-goal temporary-goal 2345)
    (up-get-search-state local-total)
)

(defrule
    (goal temporary-goal 2345)
    (unit-type-count-total villager >= 7)
    (up-set-target-object search-remote c: 7)
    (building-type-count mule-cart > 0)
    (game-time > 70)
    (up-compare-goal remote-total > 10)
=>
;    (up-remove-objects search-remote -1 != 7)
    (up-get-point position-object point-x)
    (up-lerp-tiles point-x position-self-x c: 1)
	(up-reset-search 1 1 0 0);attempt to fix georgian scout stuck bug
    (up-reset-filters)
    (up-find-local c: mule-cart c: 1)
;    (up-target-objects 0 action-move -1 -1)
;    (up-send-flare point-x)
    (set-strategic-number sn-mule-cart-dropsite-placement 0)
    (up-target-point point-x action-move -1 -1)

  ;  (chat-to-player my-player-number "Moving starting mule cart")
...
(defrule
	(goal temporary-goal2 6789)
	(up-set-target-object search-remote c: 0)
	(up-point-distance point-x position-self-x > 22)
=>
	;(chat-to-all "Fleeing part 2")
	(up-lerp-percent point-x center-x c: -10)
	(up-lerp-percent point-x position-self-x c: -20)
	(up-bound-point point-x point-x)
	(up-filter-exclude -1 actionid-build orderid-build -1)
	(up-filter-exclude -1 actionid-attack orderid-attack -1)
	(up-get-fact unit-type-count villager temporary-goal3)
	(up-modify-goal temporary-goal3 c:/ 3)
	(up-modify-goal temporary-goal3 c:max 2)
	(up-find-local c: villager-class g: temporary-goal3)
	;(up-remove-objects search-local object-data-move-x g:== point-x)
	(up-target-point point-x action-default -1 -1)
)
...
=>
	(up-full-reset-search)
	(up-find-local c: traction-trebuchet c: 1)
	(up-set-target-object search-local c: 0)
	(up-get-point position-object point-x)
	(up-modify-goal temporary-goal7 s:= sn-focus-player-number)
	(up-modify-sn sn-focus-player-number s:= sn-target-player-number)
	...
	(up-remove-objects search-local -1 > 1)
	(up-remove-objects search-local object-data-next-attack > 1000)
	(up-find-remote c: bombard-cannon c: 2)
	(up-find-remote c: unpacked-trebuchet c: 2)
	(up-find-remote c: packed-trebuchet-class c: 2)
	(up-find-remote c: mangonel-line c: 2)
	(up-find-remote c: castle c: 2)
	(up-find-remote c: town-center c: 2)
	(up-find-remote c: bombard-tower c: 2)
	(up-remove-objects search-remote -1 > 1)
	(up-target-objects 0 action-default stance-no-attack -1);stance-defensive
	(chat-to-player my-player-number "Traction trebuchet snipe")
)
...
=>
	...
	(up-find-local c: traction-trebuchet c: 15)
	(up-clean-search search-local object-data-distance search-order-asc)
	(up-remove-objects search-local object-data-target > 0)
	(up-remove-objects search-local object-data-attack-stance != stance-defensive)
	(up-set-target-object search-remote c: 0)
	(up-get-point position-object point-x)
	(up-lerp-percent point-x enemy-x c: 25)
	(up-target-point point-x action-move -1 stance-no-attack)
)
;War chariot micro

;Select median war chariot

(defrule
	(strategic-number sn-twenty-turns == 6)
	(unit-type-count war-chariot > 0)
=>
	(up-full-reset-search)
	(up-find-local c: war-chariot c: 10)
	(up-remove-objects search-local object-data-target < 0);Only analyze war chariots in battle
	(set-goal temporary-goal 0);sigma x
	(set-goal temporary-goal2 0);sigma y
	(set-goal temporary-goal3 9);number of war chariots
	(set-goal temporary-goal4 2456)
	(set-goal temporary-goal7 60);infinite loop protection
	(up-get-search-state local-total)
)

(defrule
	(goal temporary-goal4 2456)
	(up-compare-goal local-total > 0)
	(up-set-target-object search-local c: 0)
	(up-compare-goal temporary-goal7 > 0)
=>
	(up-get-object-data object-data-point-x temporary-goal5)
	(up-modify-goal temporary-goal g:+ temporary-goal5)
	(up-get-object-data object-data-point-x temporary-goal5)
	...
	(set-goal temporary-goal4 2457)
	(up-jump-rule -1)
)

(defrule
	(goal temporary-goal4 2457)
=>
	...
	(up-set-target-object search-local c: 0)
	(up-get-point position-object point-x)
	(up-get-object-target-data object-data-point-x point2-x)
	(up-get-object-target-data object-data-point-y point2-y)
	(up-get-object-data object-data-speed temporary-goal8)
	(up-set-target-point point2-x)
)
...
=>
	...
	(up-get-search-state local-total)
	(set-goal temporary-goal 0);evaluation goals
	(set-goal temporary-goal2 0)
	(up-modify-goal temporary-goal2 g:+ temporary-goal8)
	;(up-chat-data-to-player my-player-number "Critical value %d" g: temporary-goal2)
)
;My suspicion is that the best strategy regarding unit density is polarized; low desnity => line mode, medium density => barrage mode
;high density => line mode
;Higher speed suggests barrage mode

(defrule
	(goal temporary-goal4 2457)
	(up-compare-goal remote-total > 0)
	(nand(up-compare-goal remote-total > 10)
	(up-compare-goal remote-total < 3))
=>
	(up-modify-goal temporary-goal2 c:+ 50)
	(chat-to-player my-player-number "Dense units: Adjust in favour of barrage")
	(up-jump-rule 1)
)
...
=>
	...
	(chat-to-player my-player-number "Somewhat Dense units: Adjust in favour of barrage")
)
;Transform to barrage mode
(defrule
...
=>
	(up-full-reset-search)
	(up-filter-distance c: -1 c: 15)
	(up-find-local c: war-chariot-line c: 40)
	(up-target-point point-x action-transform -1 -1)
	(chat-to-player my-player-number "Transform to barrage")
	(up-jump-rule 1)
)
...
=>
	(up-full-reset-search)
	(up-filter-distance c: -1 c: 15)
	(up-find-local c: war-chariot-barrage c: 40)
	(up-target-point point-x action-transform -1 -1)
	(chat-to-player my-player-number "Transform to line")
)
...
=>
	(up-full-reset-search)
	(fe-filter-garrisoned c: 0);don't find garrisoned fishing ships
	(up-find-local c: fishing-ship-class c: 15)
	(up-get-search-state local-total)
	(set-goal temporary-goal4 9009)
	(up-modify-goal temporary-goal7 s:= sn-focus-player-number)
	(set-strategic-number sn-focus-player-number 1)
	(set-goal remote-total 0)
	(set-goal temporary-goal5 60)
)

(defrule
	(goal temporary-goal4 9009)
	(up-set-target-object search-local c: 0)
	(players-stance focus-player enemy)
=>
	(up-get-point position-object point-x)
	...
	(up-find-remote c: fire-ship-line c: 1)
	(up-find-remote c: hulk-line c: 1)
	(up-find-remote c: galley-line c: 1)
	(up-find-remote c: turtle-ship-line c: 1)
	(up-find-remote c: caravel-line c: 1)
	(up-find-remote c: longboat c: 1)
	(up-get-search-state local-total)
)
...
=>
	...
	(up-remove-objects search-remote object-data-hitpoints < 600)
	(up-clean-search search-remote object-data-distance search-order-asc)
	(up-remove-objects search-remote -1 > 0)
	(up-target-objects 0 action-garrison -1 -1)
...
(defrule
	(goal fishing-ship-garrisoned yes)
=>
	(up-full-reset-search)
...
(defrule
	...
	(building-type-count-total castle < 1)
	(up-set-target-object search-remote c: 0)
	(up-compare-goal remote-total > 9)
=>
	(up-get-point position-object point-x)
	(up-full-reset-search)
	(up-set-target-point point-x)
