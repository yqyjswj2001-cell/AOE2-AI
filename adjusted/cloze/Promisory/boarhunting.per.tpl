...
(defrule
	...
	(taunt-detected 1 230)
=>
	(acknowledge-taunt 1 230)
...
(defrule
	...
	(up-compare-goal expected-boars > 0)))))
=>
	(up-jump-rule 6)
...
=>
   ...
   (up-find-resource c: boar-class c: 5)
	(up-remove-objects search-remote object-data-id g:== boar-1-id)
	(up-remove-objects search-remote object-data-id g:== boar-2-id)
	(up-remove-objects search-remote object-data-id g:== boar-3-id)
	(up-remove-objects search-remote object-data-id g:== boar-4-id)
	(up-remove-objects search-remote object-data-id g:== boar-5-id)
   (up-get-search-state local-total)
	(up-modify-goal temporary-goal4 g:= remote-total)
   (up-modify-goal remote-total c:+ 4200)
   (up-get-indirect-goal g: remote-total temporary-goal2)
	(set-strategic-number sn-disable-villager-garrison 1)
)

(defrule
   (timer-triggered two-mins)
   ;(and(timer-triggered threesec)
...
=>
	...
	(up-set-indirect-goal g: next-boar-ptr g: temporary-goal11)
	(up-remove-objects search-remote -1 == 0)
	(up-modify-goal next-boar-ptr c:+ 1)
	(up-jump-rule -1)
)
(defrule
...
(defrule
   ...
   (up-object-data object-data-distance < 35)
   (up-object-data object-data-carry > 10)
   (up-object-data object-data-id g:!= boar-1-id)
   (up-object-data object-data-id g:!= boar-2-id)
   (up-object-data object-data-id g:!= boar-3-id)
   (up-object-data object-data-id g:!= boar-4-id)
   (up-object-data object-data-id g:!= boar-5-id)
   (up-compare-goal next-boar-ptr < 4206)
=>
	(up-get-object-data object-data-id temporary-goal)
   (up-set-indirect-goal g: next-boar-ptr g: temporary-goal)
   (up-modify-goal next-boar-ptr c:+ 1)
)
...
(defrule
   ...
   (up-object-data object-data-class == boar-class)
   (up-object-data object-data-distance < 35)
   (up-get-object-data object-data-point-x point-x)
   (up-get-object-data object-data-point-y point-y)
   (or(up-point-explored point-x != explored-no)
...
(defrule
   (goal temporary-goal4 40004)
   ;(up-set-target-by-id g: temporary-goal)
   (up-compare-goal temporary-goal < 32567)
	(up-compare-goal expected-boars < 1)
=>
...
(defrule 
   (up-compare-goal boar-1-id > 0)
=>
   (up-modify-goal current-boar-id g:= boar-1-id)
   (disable-self)
)

(defrule
   (up-compare-goal boar-hunting-stage < 2)
   (up-compare-goal current-boar-id > 0)
   (up-set-target-by-id g: current-boar-id)
...
=>
   (up-full-reset-search)
   (up-add-object-by-id search-remote g: current-boar-id)
   ...
   (up-remove-objects search-local object-data-hitpoints < 24)
   (up-clean-search search-local object-data-distance search-order-asc)
   (up-find-local c: villager-class c: 1);backup in case no such suitable villager exists
   (up-remove-objects search-local -1 > 0)
   (up-target-objects 0 action-default -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 1 ID: %d" g: temporary-goal12)
   (set-goal boar-hunting-stage 2)
	(disable-timer boar-reset-timer2)
   (enable-timer boar-reset-timer2 50)
)

(defrule
   (goal boar-hunting-stage 2)
   (up-set-target-by-id g: current-boar-id)
   (up-object-data object-data-hitpoints < 73)
   (up-object-data object-data-target == villager-class)
   (up-object-data object-data-target-time g:> minimum-boar-target-time)
=>
   (up-full-reset-search)
   (up-get-object-target-data object-data-id temporary-goal)
   (up-add-object-by-id search-local g: temporary-goal)
   (up-target-point position-self-x action-move -1 -1)
   (set-goal boar-hunting-stage 3)
	(disable-timer boar-reset-timer2)
   (enable-timer boar-reset-timer2 50)
)
...
(defrule
   (goal boar-hunting-stage 3)
   ;(unit-type-count villager-hunter > 0)
   (up-pending-objects c: building-class > 0)
=>
   (up-full-reset-search)
   ;(fe-break-point 1 c:== 1 -1)
   (up-find-local c: villager-class c: 40)
   (up-remove-objects 0 object-data-attacker-count < 1)
   ;(up-remove-objects search-local object-data-language-id != 5124);hunter language id
   (up-remove-objects search-local object-data-order == orderid-build)
)
...
(defrule
   ...
   (up-set-target-object search-local c: 0)
	(up-object-target-data object-data-class == building-class)
=>
   (up-get-object-target-data object-data-type temporary-goal)
   (up-assign-builders g: temporary-goal c: -1)
	(up-modify-goal restore-building g:= temporary-goal)
	(disable-timer boar-reset-timer2)
	(enable-timer boar-reset-timer2 25);this was set-goal?!
   (up-target-point position-self-x action-move -1 -1)
)
...
(defrule
   (goal boar-hunting-stage 3)
   (up-set-target-by-id g: current-boar-id)
   (or(up-object-target-data object-data-class != villager-class) 
   (up-object-data object-data-distance > 6))
=>
   (set-goal boar-hunting-stage 1)
   (disable-timer boar-reset-timer2)
   (up-modify-goal minimum-boar-target-time c:+ 150)
)
...
(defrule
   ...
   (up-get-object-data object-data-point-x point-x)
   (up-get-object-data object-data-point-y point-y)
   (up-modify-goal point2-x g:= position-self-x)
   (up-modify-goal point2-y g:= position-self-y)
   (up-modify-goal point2-x c:- 2)
   (up-modify-goal point2-y c:+ 1)
   (or(up-point-distance point-x point2-y < 3)
   (or(up-point-distance point-x position-self-x < 2)
   (up-object-target-data object-data-hitpoints < 5)))
=>
   (up-full-reset-search)
...
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 2 ID: %d" g: temporary-goal12)
   (set-goal boar-hunting-stage 4)
...
(defrule
   (goal boar-hunting-stage 4)
   (up-set-target-by-id g: current-boar-id)
   (up-object-data object-data-hitpoints >= 18);15
=>
   (up-full-reset-search)
...
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule ID: %d" g: temporary-goal12)
   ...
   (up-target-objects 0 action-default -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 4 ID: %d" g: temporary-goal12)
   (set-strategic-number sn-disable-villager-garrison 1)
...
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 6 ID: %d" g: temporary-goal12)
   (up-target-objects 0 action-ungarrison -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule ID: %d" g: temporary-goal12)
   (enable-timer boar-reset-timer2 150)
)

(defrule
   ;(or(timer-triggered threesec)
   ;(timer-triggered one-min))
   (goal boar-hunting-stage 4)

	(up-set-target-by-id g: current-boar-id)
   (or(timer-triggered one-min)
   (up-object-data object-data-hitpoints < 2))
=>
   (up-gather-inside c: town-center c: 0)
   (up-set-target-point position-self-x)
   (up-modify-goal temporary-goal2 g:= current-boar-id-ptr)
   (up-modify-goal temporary-goal2 c:+ 1)
   (up-get-indirect-goal g: temporary-goal2 temporary-goal5)
)

(defrule
	(taunt-detected 1 232)
	(timer-triggered threesec)
=>
	(acknowledge-taunt 1 232)
	(fe-break-point 1 c:= 1 -1)
)
...
(defrule
   ...
   (goal boar-hunting-stage 4)
   (up-set-target-by-id g: current-boar-id)
   (up-get-object-data object-data-carry temporary-goal3)
   (up-modify-goal temporary-goal2 g:= current-boar-id-ptr)
   (up-modify-goal temporary-goal2 c:+ 1)
   ...
   (up-get-object-data object-data-point-x point-x)
   (up-get-object-data object-data-point-y point-y)
   (up-get-object-data object-data-distance temporary-goal4)
   (up-modify-goal temporary-goal3 c:/ 10);adjust this with testing
   (or(up-compare-goal temporary-goal4 g:> temporary-goal3)
   (up-compare-goal temporary-goal3 < 6))
=>
   ;(fe-break-point 1 c:== 1 -1)
   (up-modify-goal current-boar-id-ptr c:+ 1)
   (up-set-indirect-goal c: current-boar-id g: current-boar-id-ptr)
   (up-get-indirect-goal g: current-boar-id current-boar-id)
   (set-goal boar-hunting-stage 1)
)
...
=>
   ...
   (up-set-target-point position-self-x)
   (up-filter-distance c: -1 c: 5)
   (up-find-resource c: boar-class c: 2)
   (up-remove-objects search-remote object-data-hitpoints < 1)
   (up-remove-objects search-remote object-data-hitpoints > 18);15
...
=>
   (up-target-objects 0 action-default -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 7 ID: %d" g: temporary-goal12)
   (chat-to-player my-player-number "Backup: Kill low HP boar near TC")
)
...
(defrule
	...
	(up-add-object-by-id search-remote g: current-boar-id)
	(up-set-target-object search-remote c: 0)
	(up-object-data object-data-hitpoints < 4)
	(up-object-data object-data-distance < 6)
...
=>
	...
	(up-target-objects 0 action-gather -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 8 ID: %d" g: temporary-goal12)
	(up-reset-search 1 1 0 0)
	(up-find-local c: villager-class c: 7)
	(up-remove-objects search-local object-data-order == orderid-build)
	;(up-remove-objects search-local object-data-dropsite != mill)
	(up-remove-objects search-local object-data-target == boar-class)
	(up-remove-objects search-local object-data-gather-type != food)
	(up-target-objects 0 action-default -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 9 ID: %d" g: temporary-goal12)
)
...
(defrule
   (timer-triggered boar-reset-timer2)
=>
   (disable-timer boar-reset-timer2)
	(up-assign-builders g: restore-building c: 1)
   (set-goal boar-hunting-stage 1)
	(chat-to-player my-player-number "Resetting boar hunting.")
)
...
=>
	...
	(up-find-status-local c: house c: 5)
	(up-find-status-local c: farm c: 5)
...
=>
	...
	(up-assign-builders c: wood-building c: 1)
	(up-assign-builders c: gold-building c: 1)
	(up-assign-builders c: food-building c: 1)
...
(defrule
	(game-time >= {{BOAR_TIME_004}})
(or	(and	(up-compare-goal totalsheep <= {{BOAR_TOTALSHEEP_005}}); 3
		(building-type-count food-building <= 0)); -total
	(and	(up-compare-goal mysheep <= {{BOAR_MYSHEEP_006}})
		(and	(game-time >= earlyBoar)
			(or	(up-compare-goal villagercounttotal >= {{BOAR_VILLAGERCOUNTTOTAL_007}})
				(up-compare-goal wood-villagers >= {{BOAR_WOOD_VILLAGERS_008}})))))
=>
	(up-modify-goal minBoar c:min {{BOAR_MINBOAR_009}})
...
=>
	(up-modify-goal minBoar c:min {{BOAR_MINBOAR_014}}))
(defrule
(or	(goal map water)
(or	(and	(game-time >= {{BOAR_TIME_015}})
		(up-compare-goal totalsheep <= {{BOAR_TOTALSHEEP_016}}))
	(and	(unit-type-count villager-shepherd >= {{BOAR_VILLAGER_SHEPHERD_017}})
		(up-compare-goal food-villagers >= {{BOAR_FOOD_VILLAGERS_018}}))))
=>
	(up-modify-goal minBoar c:min {{BOAR_MINBOAR_019}})); 10
(defrule
...
(or	(unit-type-count villager-forager >= {{BOAR_VILLAGER_FORAGER_020}})
	(unit-type-count-total villager-food <= {{BOAR_VILLAGER_FOOD_021}})))
	(up-compare-goal villagercount g:< minBoar)
	(unit-type-count villager-shepherd <= {{BOAR_VILLAGER_SHEPHERD_022}})
	(up-compare-goal totalsheep >= {{BOAR_TOTALSHEEP_023}})
=>
	(up-modify-goal minBoar c:max brit11))
(defrule
(or	(and	(up-compare-goal totalsheep <= {{BOAR_TOTALSHEEP_024}})
		(and	(game-time >= {{BOAR_TIME_025}})
			(or	(game-time >= {{BOAR_TIME_026}})
	...
	(and	(or	(dropsite-min-distance live-boar g:<= loom-dist)
		...
		(unit-type-count villager-shepherd >= {{BOAR_VILLAGER_SHEPHERD_027}})))
=>
...
(or	(dropsite-min-distance food >= 10)
	(and	(goal nomaden no)
		(and	(and	(and	(goal buildmill no)
			...
			(up-compare-goal totalsheep <= {{BOAR_TOTALSHEEP_028}}))))
	(game-time >= {{BOAR_TIME_029}})
(or	(game-time >= {{BOAR_TIME_030}})
	(goal nomaden no))
=>
...
;	(game-time > 240))
(or	(unit-type-count villager >= {{BOAR_VILLAGER_048}})
	(game-time > {{BOAR_TIME_049}})); 390
(or	(dropsite-min-distance live-boar >= 35)
	(unit-type-count villager-food < {{BOAR_VILLAGER_FOOD_050}})); test
=>
...
(up-compare-goal boar-hunting-stage < 1)
(or	(strategic-number sn-minimum-boar-hunt-group-size != 2)
	(strategic-number sn-minimum-number-hunters != 2))
(or	(dropsite-min-distance live-boar <= -1)
	(dropsite-min-distance live-boar >= 35))
...
=>
	...
	;(set-strategic-number sn-disable-all-boar-assistance 1)
	(up-jump-rule 48);41
)
(defrule
(or	(building-type-count town-center <= 0)
...
;	(game-time s:<= sn-home-exploration-time)
	...
	(up-compare-goal temporary-goal < 50);sanity check
=>
	(up-modify-goal temporary-goal c:+ 1)
	(up-reset-filters)
...
=>
	(up-remove-objects search-local object-data-target == deer-class)
)
(defrule
	(goal search-action search-action-boar-hunting)
	(up-point-distance point-x saved-point-x g:> loom-dist)
...
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 10 ID: %d" g: temporary-goal12)
	(set-goal search-action -1)
...
;	(chat-local-to-self "Capture boar.")
	...
	(up-target-objects 1 action-default -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 11 ID: %d" g: temporary-goal12)
...
;	(chat-local-to-self "Starting lure.")
	...
	(up-target-objects 0 action-default -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 12 ID: %d" g: temporary-goal12)
...
;	(set-goal boar-lurer -1)
	...
	(up-target-objects 0 action-garrison -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 13 ID: %d" g: temporary-goal12)
	(up-get-timer c: boar-reset-timer temporary-goal)
; tl	(up-modify-goal temporary-goal c:max 0)
	(up-modify-goal temporary-goal c:/ 1000)
	(up-get-fact game-time 0 temporary-goal2)
...
(or	(game-time >= 600)
	(and	(building-type-count wood-building >= 1)
		...
		(and	(up-gaia-type-count c: ocean-fish-class <= 0)
			(and	(up-gaia-type-count c: shore-fish-class <= 0)
				(and	(building-type-count-total dock <= 0)
					(and	(building-type-count-total port <= 0)
						(goal map water)))))))
=>
	(up-jump-rule 12)
	(set-goal deer-luring 0))
...
=>
	...
	(set-goal deer-luring 1);meta has changed - pushing deer more important than finding enemy
)
(defrule
	(goal current-deer -1)
	(dropsite-min-distance deer-hunting < 33);30
=>
	(up-set-target-point position-self-x)
	(up-full-reset-search)
...
(defrule
	(goal deer-luring 1);	(up-compare-goal deer-luring != 3)
(or	(dropsite-min-distance deer-hunting >= 34); live-deer ;31
	(up-compare-goal deer-distance >= 34))
=>
...
;	(chat-local-to-self "Target deer.")
	...
	(up-target-objects 1 action-default -1 -1)
;(up-get-rule-id temporary-goal12))
;(up-chat-data-to-player my-player-number "Rule 14 ID: %d" g: temporary-goal12)
;	(set-goal current-deer -1)
	(set-goal deer-distance -1)
