...
Private reference repository for Age of Empires II AI source materials copied from the laboratory repository `yqyjswj2001-cell/aoe2-ffa8-ai-audit`.
...
The DE `Promisory` copy was recorded in the source repository as originating from:

`AoE2DE/resources/_common/ai/Promisory`
